...
if (@$_POST['suporte_send']) {
			...
			<tr>
				<td>
					<table border='0'>
						...
						<tr><td>DÃºvida:</td><td>".$duvida."</td></tr>						
					</table>				
				</td>
			</tr>
		</table>			
	...
	if(@$_POST["g-recaptcha-response"]){	
		...
		if ($response != null && $response->success) {
			Util::mail(utf8_decode('TelessaÃºde - DÃºvida ou SugestÃ£o'), 'telessaude@medicina.ufc.br', 'NUTEDS', $body, 'suporte.telessaude@nuteds.ufc.br'); //$email
			Controller::setInfo('DÃºvida', 'Enviada com sucesso! Por favor aguarde!');		
		} 
		else {
			Controller::setInfo('DÃºvida', 'Erro ao verificar capcha!', 'error');
		}
	}
	else{
		Controller::setInfo('DÃºvida', 'Erro ao enviar, verifique o formulÃ¡rio!', 'error');
	}
	Controller::redirect();	
}


//Verificando a recuperaÃ§Ã£o do acesso
if (@$_POST['ds_email']) {
	$auth->passRecovery();
}

//Autenticando o usuÃ¡rio e o redirecionando
			...
			<div class="container" style="min-height:95px; padding-top:5px;">
				<div class="row">
					...
					<div class="col-sm-6 text-right">
						<a href="https://goo.gl/forms/xkmqZh64RdDAkz4m1" target="blank" class="btn btn-primary" style="margin-top:15px; margin-right:20px; width:120px;">INSCRI&Ccedil;&Atilde;O</a>	
						...
						<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modalCertificado" style="margin-top:15px; margin-right:20px; width:200px;">VERIFICAR CERTIFICADO</a>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-8 hidden-xs hidden-sm">
							...
							<div class="">
								<span style="font-size:38px; text-shadow: 2px 2px 5px #ddd; font-weight:bold;">N&Uacute;CLEO DE TELESSA&Uacute;DE DO CEAR&Aacute;</span><br>
								N&uacute;cleo de Tecnologias e Educa&ccedil;&atilde;o a Dist&acirc;ncia em Sa&uacute;de da Universidade Federal do Cear&aacute;
							</div>
	  ...
	  <form method="post">
		  <div class="modal-body">
			<div class="row">
				...
				<p>OlÃ¡! Para recuperar seu usuÃ¡rio ou senha informe o email de cadastro:</p>
...
<div class="modal fade" id="modalCertificado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Valida&ccedil;&atilde;o de Certificado</h4>
      </div>
	  <form action="valcertificado.php" onsubmit="javascript: abreResposta(this)" method="post">
		<input type="hidden" name="suporte_send" value="1"/>
		  <div class="modal-body">
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<label>C&oacute;digo de Valida&ccedil;&atilde;o</label>
					<input id="codvalid" name="codvalida" type="text" class="form-control" placeholder="Digite o C&oacute;digo de Valida&ccedil;&atilde;o" required="required"/>
				</div>
