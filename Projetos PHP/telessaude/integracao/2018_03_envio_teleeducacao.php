...
$profissionalTeleconsultorias = new ProfissionalSaude("0000088", "032018");
...
'23039035304',
'64934560378'];
$codigo_identificacao 	= 'RM2018030501';
$data 					= "05/03/2018 20:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018030502';
$data 					= "05/03/2018 08:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018031201';
$data 					= "12/03/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018031901';
$data 					= "05/03/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018032601';
$data 					= "26/03/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
