...
'04180695499',
'04223182307'];
$codigo_identificacao 	= 'RM2018100802';
$data 					= "08/10/2018 20:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018100101';
$data 					= "01/10/2018 08:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018100801';
$data 					= "08/10/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018101501';
$data 					= "15/10/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018102201';
$data 					= "22/10/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018102901';
$data 					= "29/10/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
