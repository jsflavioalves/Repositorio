...
$profissionalTeleconsultorias = new ProfissionalSaude("0000088", "042018");
...
'32138350304',
'64308421349' ];
$codigo_identificacao 	= 'RM2018040201';
$data 					= "02/04/2018 08:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349' ];
$codigo_identificacao 	= 'RM2018040901';
$data 					= "09/04/2018 08:00:00";
$ch_horaria 			= 120;
...
'23039035304',
'64934560378' ];
$codigo_identificacao 	= 'RM2018040902';
$data 					= "09/04/2018 20:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H01.158.782.323";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, TipoAtividade::REUNIAO, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018041601';
$data 					= "16/04/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, TipoAtividade::REUNIAO, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018042301';
$data 					= "23/04/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, TipoAtividade::REUNIAO, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
