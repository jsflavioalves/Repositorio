...
'04180695499',
'04223182307'];
$codigo_identificacao 	= 'RM2018091001';
$data 					= "09/09/2018 20:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018090301';
$data 					= "09/09/2018 08:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018091002';
$data 					= "10/09/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018091701';
$data 					= "17/09/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018092401';
$data 					= "24/09/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
