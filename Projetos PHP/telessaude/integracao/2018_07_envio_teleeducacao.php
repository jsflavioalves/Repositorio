...
$profissionalTeleconsultorias = new ProfissionalSaude("0000088", "072018");
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018070201';
$data 					= "02/07/2018 08:00:00";
$ch_horaria 			= 120;
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018070901';
$data 					= "09/07/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018071601';
$data 					= "16/07/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018072301';
$data 					= "23/07/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
...
'32138350304',
'64308421349'];
$codigo_identificacao 	= 'RM2018073001';
$data 					= "30/07/2018 08:00:00";
$ch_horaria 			= 120;
$tema_america 			= "H02.403.429.163";
$atividade->addAtividade($codigo_identificacao, $data, $ch_horaria, $tipo_palestra, $tema_america);
for($i=0;$i<count($cpfs);$i++) {
