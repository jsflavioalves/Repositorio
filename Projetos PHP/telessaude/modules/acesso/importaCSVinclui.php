...
?>
	...
	$arquivo = $_FILES['pdf2']['name'];
	$_SESSION['pdf2']=$arquivo;
	$tmpName =$_FILES['pdf2']['tmp_name'];
	

	if ($_FILES['pdf2']['name'] != "") {
	    $pasta = './csv/';
	     move_uploaded_file($_FILES['pdf2']['tmp_name'], $pasta . $arquivo);
	 	}
