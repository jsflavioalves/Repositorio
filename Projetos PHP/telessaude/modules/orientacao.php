...
if(isset($_POST['checkdel'])){	
	if($auth->isDelete($transacao)){	
		if(@SQL::remove('tb_orientacao', 'ci_orientacao', $_POST['checkdel'])){
			Util::notice('Orientações', 'Excluída com sucesso!', 'ok');	
		}
		else{
			Util::notice('Orientações', 'Erro ao Excluir. A orientação já pode estar sendo utilizada por uma teleconsultoria ou houve falha na conexão com o banco de dados!', 'error');
		}		
	}
	else{
		Util::info(Config::AUTH_MESSAGE);
...
?>
	...
	<div class="row bgGrey">
		...
		<span class="actiontitle">Orientações</span>
			...
			<form id="formSearch" method="post">
				...
				<table class="table table-hover table-bordered">
					...
					<tbody>
						...
						?>
						<tr>
							<td><input type="checkbox" name="checkdel[]" value="<?php echo $row['ci_orientacao']; ?>" class="btCheck"></td>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<fieldset class="" style="">
						...
						<div class="col-md-12">
							Orientação: *
							<input type="text" id="nm_orientacao" name="nm_orientacao" value="<?php echo @$rowEdit['nm_orientacao']; ?>" maxlength="50" size="35" class="form-control"/></td>
						</div>
						</div>
					</fieldset>
				</div>
