...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Rescisão</span> de Estágio</h2>
          <div class="clr"></div>
          <p>A Agência de Estágios disponibiliza modelo de rescisão de estágio. <strong>Assim, clique na opção desejada:</strong></p>
           <a href="arquivos/UFC_Estagios_Termo_Rescisao.doc" target="_blank"> Rescisão</a>
           <br> <br>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="legislacao.php">Legislacao</a></li>
      ...
      <div class="col c1">
       <h2><span>Sistemas e </span> Revistas</h2>
         ...
         <a title="Guia" href="http://ufc.br/ensino/guia-de-profissoes"><img src="/novos/banner_guia_profissoes.jpg" alt="Guia das                    Profissões" width="75" height="75" class="gal"></a>
          ...
          <a title="Sistema de Gestao de Estagio" href="http://www.estagios.ufc.br/siges/public_html/"><img                     src="images/amostra2.png" alt="Sistema de Gestao de Estagio" width="75" height="75" class="gal"></a>  
      </div>
     <div class="col c2">
      ...
      <div class="col c3">
        <h2><span>Sobre</span> Nos</h2>
        <p>Agencia de Estagios</p>
        <p class="contact_info"> <span>Endereco:</span> Avenida da Universidade, 2853<br />
  ...
  <div class="footer">
    <div class="footer_resize">
      <p class="lf">&copy; Copyright <a href="#">Agencia de Estagios</a>.</p>
