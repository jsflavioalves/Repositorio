...
<section id="blog"> 
    <div class="container">
        ...
        <div class="col-sm-7">
            <div class="row">
                <div class="article">
                  <h2><span>CkeckList</span> e Parecer no caso de reprovação</h2>
                  <div class="clr"></div>
                  <p>A Agência de Estágios disponibiliza checklist contendo a forma de avaliação dos termos de compromisso de estágio e um modelo de parecer no caso de reprovação. <strong>Assim, clique na opção desejada:</strong></p>
                   <a href="arquivos/CheckList.pdf" target="_blank">CheckList</a>
                   <br> <br>
                  <a href="arquivos/Parecer no caso de Reprovacao.doc" target="_blank">Parecer no caso de reprovação</a>
                   <br> <br>
                </div>
            </div>
        </div>
