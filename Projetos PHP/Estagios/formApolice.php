...
<section id="blog"> 
    <div class="container">
        ...
        <div class="col-sm-7">
            <div class="row">
                <div class="article">
                  <h2><span>Apólice</span> de Seguro</h2>
                  <div class="clr"></div>
                  <p>A Agência de Estágios disponibiliza cópia da apólice de seguro contra acidentes pessoais para os estudantes de graduação. <strong>Assim, clique na opção desejada:</strong></p>
                   <br> <br>
                   <a href="arquivos/Apolice UFC 2018.pdf" target="_blank">Apólice de Seguro Sura</a>
