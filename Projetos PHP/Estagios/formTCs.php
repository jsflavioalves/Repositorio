...
<head> 
    ...
    <title>Estágios UFC - Termos de Compromissos</title> 
...
<section id="blog"> 
    <div class="container">
        ...
        <div class="col-sm-7">
            <div class="row">
                <div class="article">
                  <h2><span>Formulários</span> de Estágio</h2>
                  <div class="clr"></div>
                  <p>A Agencia de Estagios disponibiliza modelos prontos de termos de compromisso de estagio.<strong>Assim, clique na opcao desejada:</strong></p>
                   <a href="arquivos/UFC_Estagios_Termo_Compromisso_N_Obrig.doc" target="_blank"> Termo de Compromisso de Estagio Nao Obrigatorio</a>
                   <br> <br>
                   <a href="arquivos/UFC_Estagios_Termo_Compromisso_Obrig.doc" target="_blank">Termo de Compromisso de Estagio Obrigatorio</a>
                   <br> <br>
                   <a href="arquivos/TERMO DE COMPROMISSO COLETIVO.doc" target="_blank">Termo de Compromisso Coletivo</a>
                   <br> <br>
                   <a href="arquivos/Termo de Compromisso de Estagio Nao Obrigatorio na UFC.doc" target="_blank">Termo de Compromisso de Estágio Não Obrigatório na UFC</a>
                   <br> <br>
                </div>
            </div>
        </div>
