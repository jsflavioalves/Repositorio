...
<section id="blog"> 
    <div class="container">
        ...
        <div class="col-sm-7">
            <div class="row">
                <div class="article">
                  <h2><span>Formulários</span> de Convênio de Estágio</h2>
                  <div class="clr"></div>
                  <p>A Agência de Estagios disponibiliza modelos de convênio de estágio. <strong>Assim, clique na opção desejada:</strong></p>
                   <a href="arquivos/UFC_Estagios_Termo_de_Convenio_Empresa.doc" target="_blank"> Termo de Convênio - Empresa / Instituição</a>
                   <br> <br>     
                    <a href="arquivos/UFC_Estagios_Termo_de_Convenio_Prof_Liberal.doc" target="_blank"> Termo de Convênio - Profissional Liberal</a>
                   <br> <br>    
                   <a href="arquivos/UFC_Estagios_T_Convenio_Agente_Integracao.doc" target="_blank"> Termo de Convênio - Agente de Integração</a> 
                </div>
            </div>
        </div>
    </div>
