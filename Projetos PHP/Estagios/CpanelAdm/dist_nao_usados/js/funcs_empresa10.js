...
function buscarNoticias10(valor) {
...
var url = "busca_empresa.php?valor="+valor;
...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('resultado10').innerHTML = 'Buscando...';
	}
	...
	document.getElementById('resultado10').innerHTML = resposta;
	}
}
req.send(null);
}
