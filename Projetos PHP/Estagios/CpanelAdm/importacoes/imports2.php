...
<body class="hold-transition skin-blue sidebar-mini" style="background:#c1c1c1">
            ...
            <section class="content">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">IMPORTAÇÃO DO CONTEUDO XML PARA MYSQL</h3>
                </div>
                <!-- /.box-header -->
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <form action="upload_insert2.php" enctype="multipart/form-data" method="POST">
