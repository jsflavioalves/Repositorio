            ...
            <section class="content">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <a href="limpar_tabela.php">
                  <input type="submit" value="LIMPAR TABELA" style="float:right;width:20%;height:33px;"></a>
                </div>
                <!-- /.box-header -->
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <form action="upload_insert.php" enctype="multipart/form-data" method="POST">
