...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content"> 
      ...
      $tceo=mysqli_query($conn,"SELECT*FROM termo_compromisso WHERE classificacao_termo LIKE 'OBRIGATORIO'");
      $result_tceo=mysqli_num_rows($tceo);
      
      $tceo1=mysqli_query($conn,"SELECT dt_inicio, SUBSTRING(dt_inicio, 1, 5) FROM termo_compromisso WHERE dt_inicio like '%2018%' AND classificacao_termo LIKE 'OBRIGATORIO'");
      $result_tceo1=mysqli_num_rows($tceo1);
      
      $tceno=mysqli_query($conn,"SELECT*FROM termo_compromisso WHERE classificacao_termo != 'OBRIGATORIO'");
      $result_tceno=mysqli_num_rows($tceno);
      
      $tceno1=mysqli_query($conn,"SELECT dt_inicio, SUBSTRING(dt_inicio, 1, 5) FROM termo_compromisso WHERE dt_inicio like '%2018%' AND classificacao_termo != 'OBRIGATORIO'");
      $result_tceno1=mysqli_num_rows($tceno1);
      
      $ta=mysqli_query($conn,"SELECT*FROM termo_compromisso WHERE tipo_termo LIKE 'T.A'");
      $result_ta=mysqli_num_rows($ta);
      $ta1=mysqli_query($conn,"SELECT dt_inicio, SUBSTRING(dt_inicio, 1, 5) FROM termo_compromisso WHERE dt_inicio like '%2018%' AND tipo_termo LIKE 'T.A'");
      $result_ta1=mysqli_num_rows($ta1);
      $declaracao=mysqli_query($conn,"SELECT*FROM declaracao");
      $result_declaracao=mysqli_num_rows($declaracao);
      $curso=mysqli_query($conn,"SELECT*FROM cursos");
      $result_curso=mysqli_num_rows($curso);
      $centros=mysqli_query($conn,"SELECT*FROM centros");
      $result_centros=mysqli_num_rows($centros);
      $empresas=mysqli_query($conn,"SELECT*FROM empresas");
      $result_empresas=mysqli_num_rows($empresas);
      $emp1=mysqli_query($conn,"SELECT*FROM termo_convenio WHERE SUBSTRING( dt_inicio, 7, 4 ) = '2015' OR SUBSTRING( dt_inicio, 7, 4 ) = '2016' OR SUBSTRING( dt_inicio, 7, 4 ) = '2017' OR SUBSTRING( dt_inicio, 7, 4 ) = '2018'");
      $result_emp1=mysqli_num_rows($emp1);
      $agentes=mysqli_query($conn,"SELECT*FROM agentes");
      $result_agentes=mysqli_num_rows($agentes); 
      ...
      <div class="row">
        <div class="col-md-6 col-sm-8 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">TCE OBRIGATORIO - 2018</span>
        ...
        <div class="col-md-6 col-sm-8 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">TCE NÃO OBRIGATORIO - 2018</span>
        ...
        <div class="col-md-6 col-sm-8 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">TERMO ADITIVO - 2018</span>
      ...
      <div class="row">
        <div class="col-md-6 col-sm-8 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">TOTAL DE CONVÊNIOS VIGENTES</span>
      ...
      <div class="col-md-12">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <center><img src="pages/forms/acao_grafico1.php"></center> 
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
      ...
      <div class="col-md-12">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <center><img src="pages/forms/acao_grafico2.php"></center> 
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
      ...
      <div class="col-md-12">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <center><img src="pages/forms/acao_grafico3.php"></center> 
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
      ...
      <div class="col-md-12">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <center><img src="pages/forms/acao_grafico4.php"></center> 
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
      ...
      <div class="col-md-12">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">CONVÊNIOS VIGENTES NOS ULTIMOS 6 ANOS</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <center><img src="pages/forms/acao_grafico6.php"></center> 
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
      ...
      <div class="col-md-12">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <center><img src="pages/forms/acao_grafico5.php"></center> 
            </div>
            <!-- /.col -->
          </div>
          <!-- /.row -->
