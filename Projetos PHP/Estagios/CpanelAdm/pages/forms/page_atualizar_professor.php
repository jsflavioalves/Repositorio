...
<!--AQUI IRA RECEBER O NOME DO SETOR QUE FOI ESCOLHIDO PARA ATUALIZAR SE ESTIVER CADASTRADO NA TABELA DE DADOS-->
<?php
// Incluir aquivo de conexão
include("../../../conn.php");
mysql_select_db('estagios');
 if(isset($_POST['siapebtn'])){

// Recebe o valor enviado
$valor = utf8_decode($_POST['prof']);
 
// Procura titulos no banco relacionados ao valor
$sql = mysql_query("SELECT * FROM professor_orientador WHERE nome LIKE '$valor' OR siape LIKE '$valor'");
...
if($resulatdo != 0){
 ...
 $id_professor=$noticias->id_professor;

        if ($id_professor!=null) {
  echo utf8_encode('<form action="acao_atualizar_professor.php" method="POST">
                                  <label> Nome </label>
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="nome" style="text-transform:uppercase" class="form-control" value="'.$noticias->nome.'">
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="siape" style="text-transform:uppercase" class="form-control" value="'.$noticias->siape.'" maxlength="7">
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="telefone" style="text-transform:uppercase" class="form-control" value="'.$noticias->fone.'" id="editar_fone" onkeypress="fone_prof(this);" maxlength="15">
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="email" style="text-transform:uppercase" class="form-control" value="'.$noticias->email.'">
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="lotacao" style="text-transform:uppercase" class="form-control" value="'.$noticias->lotacao.'">
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="cpf" style="text-transform:uppercase" class="form-control" value="'.$noticias->cpf.'" id="editar_cpf" onkeypress="fone_cpf(this);" maxlength="14">
                                          </div>
                                 
  
                                  <input type="hidden" name="id_professor" value="'.$noticias->id_professor.'"/><br>
                                  <button type="submit" id="mostrar()" name="siapebtn2" class="btn btn-primary pull-left">Salvar</button>
                                  </form>
                                     <a href="professores.php"><button type="submit" class="btn btn-danger pull-right">Cancelar</button></a>');
