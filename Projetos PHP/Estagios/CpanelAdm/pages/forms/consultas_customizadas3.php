...
<head>
  ...
  <script type="text/javascript">
    ...
    function Enviar(opc){
      ...
      document.form.action = "acao_consulta_customizada3.php";
      document.form.submit();
      }
      if(opc == 2){
      document.form.action = "acao_consulta_customizada_xls3.php";
      document.form.submit();
      }
    }
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <center>
                  ...
                  <h3 class="box-title">CONSULTAS CUSTOMIZADAS (EMPRESAS):</h3>
                </center>
              </div>
              <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon right">
                    <input  type="text" name="dt_inicio" placeholder="EX.: 2016" class="form-control" />   
                  </div>
                </div>
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon left">
                    <input type="radio" name="opt" value="relacao_alunos"/> RELAÇÃO DE ALUNOS
                    <br>   
                    <input type="radio" name="opt" value="emp_curso"/> EMPRESA POR CURSO
                    <br>
                    <input type="radio" name="opt" value="curso_emp"/> CURSO POR EMPRESA
                    <br>    
                  </div>
                </div>
