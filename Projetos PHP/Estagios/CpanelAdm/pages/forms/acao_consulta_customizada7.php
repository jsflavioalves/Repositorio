...
while($z <= 3){
	$ano = $dt_inicio-$z;
		...
		echo '<table border="1">';
		echo '<tr>';
		echo '<td colspan="2" style="color:green;"><center><b>Relatório de Estágios na UFC - Setor - '.$ano.'</b></center></td>';
		echo '</tr>';
		echo '<tr>';
		echo '<td style="width:450px; text-align:center;"><b>Setor</b></td>';
