...
<head>
  ...
  <title>Agência de Estágio | Atualizar Convênios Pendentes</title>
...
include("../../../conn.php");
 mysql_select_db('estagios');
// Recebe o valor enviado do formulario de convenios_pendentes.php em atualizar convenio pendente
if(isset($_POST['btnpen'])){
...
if($resulatdo != 0){
  ...
  //recebe o id que esta registrado no banco de dados
  $id_convenios_pendentes=$noticias->id_convenios_pendentes;

        if ($id_convenios_pendentes!=null) {
  //armazena os valores do convenio pesquisado nas inputs
  echo utf8_encode('<form action="acao_atualizar_conv_pendentes.php" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                            <div class="input-group">
                              ...
                              <input type="text" onclick="mostrar_salvar()" class="form-control" data-inputmask=""alias": "dd/mm/yyyy"" data-mask id="conv4" onkeypress="data(this)" maxlength="10" name="data_arquivamento" value="'.$noticias->data_arquivamento.'">
                            </div>
                    </div>

                    <label>Data E-mail 01</label>
                    <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                              ...
                              <input type="text" onclick="mostrar_salvar()" class="form-control" data-inputmask=""alias": "dd/mm/yyyy"" data-mask id="conv4" onkeypress="data(this)" maxlength="10" name="data_email_01" value="'.$noticias->data_email1.'">
                            </div>
                    </div>

                    <label>Data E-mail 02</label>
                    <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                              ...
                              <input type="text" onclick="mostrar_salvar()" class="form-control" data-inputmask=""alias": "dd/mm/yyyy"" data-mask id="conv4" onkeypress="data(this)" maxlength="10" name="data_email_02" value="'.$noticias->data_email2.'">
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                            <div class="input-group">');
                             ...
                             echo'<a href="convenio_pendentes/'.$noticias->arquivo.'"> <input type="button" onclick="mostrar_salvar()" id="conv" class="btn btn-success" name="observacao" value="'.$noticias->arquivo.'"></a>';
                              }
                            echo utf8_encode('</div>
                           <td><input name="pdf" class="realupload" type="file" id="arquivo_file" accept=”image/*”></td>
                    </div>

        <input type="hidden" name="id_convenios_pendentes" value="'.$noticias->id_convenios_pendentes.'"/>
                    ...
                    <a href="convenios_pendentes.php"><button type="submit" class="btn btn-danger pull-right">Cancelar</button></a>'); 
}
}
if ($resulatdo == 0) {
