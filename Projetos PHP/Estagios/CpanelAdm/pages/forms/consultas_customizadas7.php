...
<head>
  ...
  <script type="text/javascript">
    function Enviar(opc){
      if(opc == 1){
      document.form.action = "acao_consulta_customizada7.php";
      document.form.submit();
      }
      if(opc == 2){
      document.form.action = "acao_consulta_customizada_xls7.php";
      document.form.submit();
      }
    }
  </script>
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <center>
                  ...
                  <h3 class="box-title">CONSULTAS CUSTOMIZADAS (ESTÁGIOS NA UFC):</h3>
                </center>
              </div>
              <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon left">
                    <input type="radio" name="opt" value="setor"/> SETOR
                    <br>    
                  </div>
                </div>
