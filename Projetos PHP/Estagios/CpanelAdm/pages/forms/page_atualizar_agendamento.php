...
<head>
  ...
  <script type="text/javascript">
    function data(nova_data) {
          if (nova_data.value.length == 2) {
              nova_data.value = nova_data.value+'/';
          };
          if (nova_data.value.length == 5) {
              nova_data.value = nova_data.value+'/';
          };
      }

     function hora(nova_hora) {
          if (nova_hora.value.length == 2) {
              nova_hora.value = nova_hora.value+':';
          };
      }
              ...
              <div class="box box-primary">
                <div class="form-group">
                  <div class="box-header with-border">
                   <h3 class="box-title">Atualizar Agendamento</h3>
                   </div>
                  <div class="box-body">
                   
<!--AQUI IRA RECEBER O NOME DO CENTRO QUE FOI ESCOLHIDO PARA ATUALIZAR SE ESTIVER CADASTRADO NA TABELA DE DADOS-->
<?php
...
$data_antiga = $noticias['data'];
$hora_antiga = $noticias['hora'];

echo'<form action="acao_atualizar_agendamento2.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="id_agendamento" class="form-control" value="'.$noticias['id_agendamento'].'" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="matricula_aluno" class="form-control" value="'.$noticias['matricula_aluno'].'" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nome_aluno" style="text-transform:uppercase" class="form-control" value="'.$noticias['nome_aluno'].'" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nova_data" name="nova_data" onkeypress="data(this)" maxlength="10" class="form-control" value="'.$noticias['data'].'" placeholder="dd/mm/aaaa">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nova_hora" name="nova_hora" onkeypress="hora(this)" maxlength="5" class="form-control" value="'.$noticias['hora'].'" placeholder="00:00">
                        </div>
                    </div>

                    <input type="hidden" value="'.$data_antiga.'" name="data_antiga">
                    <input type="hidden" value="'.$hora_antiga.'" name="hora_antiga">
                    <input type="hidden" value="'.$noticias['id_agendamento'].'" name="id_agendamento">
                    <button type="submit" name="btn" class="btn btn-success pull-left">Salvar</button>
                    </form>
                    <a href="consultar_vagas_agendamento.php"><button type="button" class="btn btn-danger pull-right">Cancelar</button></a>';
