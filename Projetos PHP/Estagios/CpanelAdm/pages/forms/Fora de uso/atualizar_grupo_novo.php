...
<!--AQUI IRA RECEBER O NOME DO GRUPO QUE FOI ESCOLHIDO PARA ATUALIZAR SE ESTIVER CADASTRADO NA TABELA DE DADOS-->
<?php
// Incluir aquivo de conexão
include("../../../conn.php");
mysql_select_db('estagios');
 if(isset($_POST['grupobtn'])){

// Recebe o valor enviado
$valor = utf8_decode($_POST['grupo']);
 
// Procura titulos no banco relacionados ao valor
$sql = mysql_query("SELECT * FROM grupo_vagas WHERE descricao_grupo LIKE '$valor'");
...
if($resulatdo != 0){
 ...
 $id_grupo=$noticias->id_grupo;

        if ($id_grupo!=null) {
  echo utf8_encode('<form action="atualizar_grupo.php" method="POST">
                                  </br><label> Nome do Grupo de Vagas </label>
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="nome_grupo" style="text-transform:uppercase" class="form-control" value="'.$noticias->descricao_grupo.'">
                                          </div>
                                  </div>
  
                                  <input type="hidden" name="id_grupo" value="'.$noticias->id_grupo.'"/>
                                  <button type="submit" id="mostrar()" name="grupobtn2" class="btn btn-primary pull-left">Salvar</button>
                                  </form>
                                     <a href="grupo.php"><button type="submit" class="btn btn-danger pull-right">Cancelar</button></a>');
