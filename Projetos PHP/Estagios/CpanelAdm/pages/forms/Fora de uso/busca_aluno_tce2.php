  ...
  $matricula = $noticias->matricula;
      ...
      if($resulatdo1 == 0){
          ...
          echo utf8_encode('<br>
                ...
                echo '<div id="adc" style="display:none;" >
                        <div class="row">
                          <div class="col-xs-12"><br>
                            <div class="box box-primary">
                              <div class="box-header">
                                <h3 class="box-title">Adicionar Termos de Compromisso</h3>
                                  ...
                                  <div class="col-xs-6">
                                  <label>CONCEDENTE/EMPRESA</label>
                            <td><input type="text" id="desabilitar2" OnKeypress="completar();"  name="concedente_n" class="form-control" required></td>  
                           </div>

                              <div class="col-xs-4">
                              <label>SETOR_UFC</label>
                                   <select class="form-control select2" id="desabilitarsetor" name="setor_n">
                            ...
                            echo '</select>
                              ...
                              <td>
                                <div class="col-xs-2">
                                <label>HORARIO_VARIADO</label>
                                  <select class="form-control select2" id="desabilitar8" name="variavel_n" required>
                                    <option selected="selected"></option>
                                    <option>SIM</option>
                                    <option>NÃO</option>
                                  </select>
                              ...
                              <div class="col-xs-2">
                              <label>TIPO_DE_TERMO</label>
                                <td>
                                  <div class="form-group">
                                    <select class="form-control select2" id="desabilitar10" name="tp_termo_n" required>
                                      <option selected="selected"></option>
                                      <option>T.A</option>
                                      <option>T.C</option>
                                    </select>
                              ...
                              <td>
                               <div class="col-xs-2">
                                <label>CLASSIFICAÇÃO_DO_TERMO</label>
                                  <select class="form-control select2" id="desabilitar11"  name="cl_termo_n" required>
                                    <option selected="selected"></option>
                              ...
                              <td> 
                                <div class="col-xs-2">
                                <label>RELATORIO_SEMESTRAL</label>
                                  <select class="form-control select2" id="desabilitar12" name="relatorio_n" required>
                                    <option selected="selected"></option>
                                    <option>SIM</option>
                                    <option>NÃO</option>
                                  </select>
                              ...
                              <td>
                               <div class="col-xs-4">
                                <label>AGENTE_DE_INTEGRAÇÂO</label>
                            ...
                            echo '</select>
                              ...
                              <div class="col-xs-4">
                              <label>PROF.ORIENTADOR</label>
                                <td><input type="text" id="desabilitar14" class="form-control" name="prof_n" placeholder="Prof. Orientador" required></td>
                              </div>
                              <div class="col-xs-2">
                              <label>SIAPE</label>
                                <td><input type="number" id="desabilitar16" class="form-control" name="siape" placeholder="SIAPE" required></td>
                                </div>
                                <div class="col-xs-4">
                                <label>ARQUIVO</label>
                                ...
                                <td><input type="text" id="desabilitar18" class="form-control" name="obs" placeholder="Observacao"></td>
                              </div>
                      ...
                      // Procura tabela termo_compromisso todos os registros em que 'matricula_aluno' for igual a variavel '$noticias->matricula' em ordem crescente e alfabética segundo o 'id_termo_compromisso'
...
//Verifica se o resultado da primeira consulta e igual a ZERO, se for executa a linha de código
if ($resulatdo == 0) {
    echo utf8_encode('
