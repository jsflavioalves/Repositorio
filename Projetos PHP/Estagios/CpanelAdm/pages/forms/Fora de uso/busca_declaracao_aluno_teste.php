                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    <div class="form-group" id="btn" style="display: block;">
                        <form action="busca_declaracao_aluno_teste.php" method="POST">
...
if($resulatdo1 != 0){
      ...
      echo utf8_encode('<tr>
        ...
        echo utf8_encode('<td>'.$noticias3['classificacao_termo'].'</td>
                          ...
                          <td><form action="gerar_declaracao_teste.php" onsubmit="javascript: abreResposta(this)" method="POST">
                      ...
                      if($noticias3['obs'] == "FALTA VIA UFC"){
                        echo '<button type="button" class="btn btn-danger pull-right">FALTA VIA UFC</button>';
                      }else{
                        echo '<button type="submit" class="btn btn-primary pull-right" type="button" class="btn btn-box-tool">GERAR</button>';
                      }
                          echo '</form>
                          </td>
                        </tr>';
                  }
                  $sql4 = mysql_query("SELECT * FROM alunos WHERE nome LIKE '%$valor%' or matricula like '%$valor%'");
                  $noticias4 = @mysql_fetch_array($sql4);
    echo utf8_encode('</table>
                    </div>   
                  </div>
                     <form action="gerar_declaracao_todos.php" onsubmit="javascript: abreResposta(this)" method="POST">
