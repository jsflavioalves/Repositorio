    ...
    <div class="content">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              ...
              <form action="inserir_agente.php" method="POST">
            <div class="box-body">
              <!-- Date dd/mm/yyyy -->
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                <form action="busca_agente.php" method="POST">
                  <div class="form-group">
                    <label>Escolha um agente de integração para atualizar</label>
                   
                     <input id="agente" name="agente" onkeypress="completaragente();" type="text" style="text-transform:uppercase" placeholder="Nome do centro" class="form-control" /></br>
                    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <form action="deleta_agente.php" method="POST">
                  <label>Selecione um agente de integração para excluir</label>
