...
<head>
  ...
  function completargrupo() {
          
        
            $(document).ready(function(){
              $('#grupo').autocomplete(
              { 
                source: "search_atual_grupo.php",
                minLength: 1,
                delay: 0
              });
    ...
    <div class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Inserir Novo Grupo de Vagas</h3>
        </div>
        <!--PARTE QUE INSERE UM GRUPO NOVO CASO NAO SEJA CADASTRADO-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Nome do Grupo</label>
                <form action="inserir_grupo.php" method="POST">
                  <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-user-plus"></i></div>
                      <input type="text" class="form-control" name="descricao_grupo" style="text-transform:uppercase" placeholder="Nome do Grupo">
                  </div>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Atualizar Grupo de Vagas</h3>
        </div>
        <!--PARTE QUE ATUALIZA UM GRUPO POR MEIO DE PESQUISA AUTOCOMPLETE E FORMULARIO-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                <form action="atualizar_grupo_novo.php" method="POST">
                  <div class="form-group">
                    <label>Escolha um grupo de vagas para atualizar</label>
                    <input id="grupo" name="grupo" onkeypress="completargrupo();" type="text" style="text-transform:uppercase" placeholder="Nome do Grupo" class="form-control" /></br>
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-primary pull-right" name="grupobtn" style="float: right; display:block;">Atualizar</button>
                    </div>
                  </div>
                </form>
              </div>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Excluir Grupo de Vagas</h3>
        </div>
        <!--PARTE QUE EXCLUI UM GRUPO DE ACORDO COM A ESCOLHA FEITA-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <form action="deleta_grupo.php" method="POST">
                  <label>Selecione um grupo de vagas para excluir</label>
                  <select class="form-control select2" name="id_grupo" style="width: 100%;">
                    <?php 
                      require('../../../conn.php');
                      ...
                      while ($sql = mysql_fetch_array($consulta)) {
                        $id_grupo = $sql['id_grupo'];
                        $descricao_grupo = $sql['descricao_grupo'];

                        echo utf8_encode('<option value="'.$id_grupo.'">'.$descricao_grupo.'</option>');
                      }
                     ?>
                  </select>
                  <div class="col-md-12"><br>
