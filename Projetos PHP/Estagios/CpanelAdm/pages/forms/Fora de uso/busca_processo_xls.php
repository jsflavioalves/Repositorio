...
<head>
  ...
  <script type="text/javascript">
    ...
    function completar_busca_conv() {
        ...
        function completar_busca_emp() {
          
        
            $(document).ready(function(){
              $('#nome_emp').autocomplete(
              { 
                source: "search_busca_emp_xls.php",
                minLength: 1,
                delay: 0
              });
              ...
              <div class="box box-primary">
                <div class="form-group">
                  <div class="box-header with-border">
                    <form action="acao_busca_cnv_xls.php" method="POST">
                      <div class="box-body">
                        <h3 class="box-title">Consultar Convênios de Uma Empresa</h3>
                          <div class="form-group">
                            <div class="form-group">
                                <br><label>Ano dos Convênios:</label>
                            <div class="input-icon right">
                              <input type="text" name="ano" placeholder="EX.: 2017" maxlength="4" class="form-control" />
                            </div>
                          </div>
                              <input type="submit" name="btn_xls1" value="Consultar" class="btn btn-primary pull-right">
                        </div>
                      </div>
                    </form>
                  </div>
