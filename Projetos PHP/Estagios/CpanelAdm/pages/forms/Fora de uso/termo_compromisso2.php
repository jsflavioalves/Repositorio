...
<head>
  ...
  <script>
   ...
   // Funções de autocomplete das inputs //
    ...
    function Enviar(opc){
      if(opc == 1){
      document.form.action = "atualizar_matricula.php";
      document.form.submit();
      }
      if(opc == 2){
      document.form.action = "busca_aluno_tce_2.php";
      document.form.submit();
      }
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content" id="cadastrar_aluno">
      ...
      <div class="row">
        <div class="col-md-12" style="display:block;">
          <section>
            <div class="col-xs-6">
                <!-- Formulário para Consultar Alunos -->
                        ...
                        <form action="" method="POST" name="form" id="form" onSubmit="">
                          <div class="form-group" id="pesquisa">
                              <div class="input-icon right" id="busca">
                                <div class="col-md-12">
                                    <input id="aluno" onkeypress="completar_con_aluno()" type="text" name="aluno" placeholder="Nome/Matrícula do Aluno" class="form-control" /><br>
                                 
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                      <button type="submit" class="btn btn-block btn-success" name="btn_atualizar" onClick="Enviar(1);" style="float: left; display:block;">Trocar Matrícula</button>
                                    </div>
                                    <div class="col-md-4">
          ...
          <div class="col-xs-6">
                <!-- Formulário Para Exclusão de Alunos -->
                <div class="box box-primary collapsed-box">
                  ...
                  <div class="box-body">
                    <div class="form-group" id="btn" style="display: block;">
                        <form action="deleta_aluno.php" method="POST">
                          <div class="form-group" id="pesquisa">
                              <div class="input-icon right" id="busca">
                                <div class="col-md-12">
    ...
    <div class="col-xs-12">
            ...
            ?>  
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input name="matricula" class="form-control" type="text" placeholder="Nº de Matricula" style="text-transform:uppercase" required>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
      ...
      <div class="col-xs-6">
        ...
        <form action="autenticar_externo.php" method="POST">
          <div class="box box-primary collapsed-box">
            <div class="box-header">
