...
<head>
  ...
  <script>
    function declaracao_aluno() {
      var mudar = document.getElementById("dasinp").style.display = 'block';
      var mudar = document.getElementById("tabela").style.display = 'block';
                        ...
                        <form action="busca_declaracao_aluno_teste.php" method="POST">
                          <div class="form-group" id="pesquisa">
                              <div class="input-icon right" id="busca">
                                <div class="col-md-12">
                                    <input id="input1" onkeypress="completar_declaracao()" type="text" name="input1" placeholder="Nome ou Matricula do Aluno" class="form-control" /><br>
