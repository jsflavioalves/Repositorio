...
// if ($rescisao == '') {
	//$pdf->MultiCell(520, 22, utf8_decode('      Declaramos para os devidos fins que o (a) aluno (a) '.$nome.', matriculado (a) no curso de '.$curso.', matrícula nº '.$matricula.', desenvolveu atividades de estágio curricular '.$classificacao_termo.' na empresa '.$nome_empresa.', com carga horária de '.$carga_horaria.' horas semanais, no período compreendido entre '.$dt_inicio.' a '.$dt_fim.', em conformidade com a Lei 11.788 de 25 de Setembro de 2008 e resolução nº 32/CEPE de 30 de Outubro de 2009.'), 0, 'J');
// }
// if ($rescisao != '') {
	//$pdf->MultiCell(520, 22, utf8_decode('      Declaramos para os devidos fins que o (a) aluno (a) '.$nome.', matriculado (a) no curso de '.$curso.', matrícula nº '.$matricula.', desenvolveu atividades de estágio curricular '.$classificacao_termo.' na empresa '.$nome_empresa.', com carga horária de '.$carga_horaria.' horas semanais, no período compreendido entre '.$dt_inicio.' a '.$rescisao.', em conformidade com a Lei 11.788 de 25 de Setembro de 2008 e resolução nº 32/CEPE de 30 de Outubro de 2009.'), 0, 'J');
//}
