...
<div class="content-wrapper">
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">CONVÊNIOS VIGENTES</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php 
                 ...
                 $sql0 = mysql_query("SELECT * FROM empresas order by nome ASC ");
    ...
    if($resulatdo != 0){
        echo'<br>';
       while($noticias0 = @mysql_fetch_object($sql0)){

          $sql1 = mysql_query("SELECT * FROM termo_convenio WHERE CD_EMPRESA LIKE '$noticias0->CD_EMPRESA' ");
...
if ($agt_int!=null) {
echo utf8_encode('<tr>
                            <td><label id="ret_proc_nome">'. $CD_EMPRESA.'</label></td>
                            <td>'.$nome.'</td>
                            <td><label id="ret_proc_nome">'.$agt_int.'</label></td>
    ...
    echo utf8_encode('<tr>
                            <td><label id="ret_proc_nome">'. $CD_EMPRESA.'</label></td>
                            <td>'.$nome.'</td>
                            <td><label id="ret_proc_nome">'.$dt_inicio.'</label></td>
                            <td><label id="ret_proc_nome">'.$data_fim.'</label></td>
                          </tr>');       
        } 
...
<script src="../../dist/js/funcs_tceano.js"></script>

<script src="../../dist/js/funcs_convenio_r.js"></script>

<script src="../../dist/js/funcs_tceo.js"></script>

<script src="../../dist/js/funcs_tceno.js"></script>

<script src="../../dist/js/funcs_ta_r.js"></script>

<script src="../../dist/js/funcs_curso.js"></script>
<!-- Page script -->
<script>
