...
$sql = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%$valor%' and classificacao_termo != 'OBRIGATORIO' ");
...
$sql1 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%01-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql2 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%02-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql3 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%03-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql4 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%04-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql5 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%05-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql6 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%06-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql7 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%07-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql8 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%08-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql9 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%09-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql10 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%10-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql11 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%11-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
...
$sql12 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%12-$valor%'  and classificacao_termo != 'OBRIGATORIO'");
