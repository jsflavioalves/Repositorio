    ...
    <div class="content">
        ...
        <div class="col-md-6">
          <!--<div class="col-md-8">-->
            <section class="content">
              <!-- SELECT2 EXAMPLE -->
              <!--opcs que mostram os convênios que estão sendo vencidos hj e os quais já foram vencidos-->
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
            <!--botoes com links para as paginas que estão divididas em convenios_vencidos e convenios_vencidos_hoje-->
                        <center>
                        <a target="_blank" href="page_todos_convenios_vencidos.php"><button type="submit" class="btn btn-success"> Todos os Convênios Vencidos</button></a><br><br>
                        <a target="_blank" href="page_convenios_vencendo_hoje.php"><button type="submit" class="btn btn-success">Somente Convênios Vencidos Hoje</button></a>
                        </center>
            <!-- /.col -->
          </div>
          <!-- /.row -->
