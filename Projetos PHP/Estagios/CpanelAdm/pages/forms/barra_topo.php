<div class="navbar-custom-menu">
  <ul class="nav navbar-nav">
    ...
    <li class="dropdown messages-menu">
      ...
      <ul class="dropdown-menu">
        ...
        <li>
          ...
          <ul class="menu">
            <?php 
              while ($emails_result=mysqli_fetch_array($emails)) {
          ...
          <ul class="menu">
           ...
           <?php 
              while ($notification_result=mysqli_fetch_array($notification)) {
                ...
                $aluno=mysqli_query($conn,"SELECT*FROM alunos WHERE id_aluno LIKE '$id_aluno'");
                $aluno_result=mysqli_fetch_array($aluno);
                $nome_aluno=$aluno_result['nome'];
                $curso_aluno=$aluno_result['curso'];

                $termo=mysqli_query($conn,"SELECT*FROM termo_compromisso WHERE id_termo_compromisso LIKE '$id_termo'");
                ...
                echo '<li style="position: relative;">
				              <form action="fazer_declaracao.php" method="POST">
    ...
    <li class="dropdown user user-menu">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        <img src="perfil/<?php echo $foto; ?>" class="user-image" alt="User Image">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="user-header">
          ...
          <p>
            ...
            <small>AGÃŠNCIA DE ESTÃ�GIO - UFC</small>
          </p>
        </li>
        <!-- Menu Body -->
        <li class="user-body">
