...
<div class="wrapper">
  ...
  <!--codigo que mostra a consulta de uma empresa mostrando todos os dados cadastrados da mesma e tendo a possibilidade de fazer qualquer alteração nos dados da empresa-->
...
include("../../../conn.php");
 mysql_select_db('estagios');
// Recebe o valor enviado da pagina cadastro_empresas_agentes.php no formulario de atualizar empresa
if(isset($_POST['btna'])){
...
if($resulatdo != 0){
  ...
  $CD_EMPRESA=$noticias->CD_EMPRESA;
        ...
        if ($CD_EMPRESA!=null) {
  //recebe os valores da empresa pesquisada dentro das inputs
  echo utf8_encode('<form action="acao_atualizar_empresa.php" method="POST">
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" id="email" class="form-control" name="email" value="'.$noticias->email.'">
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" id="uf" class="form-control" name="uf" value="'.$noticias->cidade_uf.'">
                                          </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" id="representante" class="form-control" name="representante" value="'.$noticias->representante.'">
                                          </div>
                                  </div>
                                  <label>CEP:</label>
                          ...
                          echo utf8_encode('<label> Tipo de Empresa: </label>
                                  <div class="form-group" id="mostrar_div2">
                                          <div class="input-group">
                                            <div class="input-group-addon">
                                              <i class="fa fa-calendar"></i>
...
//caso nao tenha nenhum resultado encontrado ira gerar esse if com a mensagem
if ($resulatdo == 0) {
