                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td><input type="text" class="form-control" onkeypress="mascara2(this, mascara);"
                        id="dom_tard" name="dom_tard" maxlength="29" ></td>
                    </tr>
                    <tr>
                      <td>NOITE</td>
                      ...
                      <td><input type="text" class="form-control" onkeypress="mascara2(this, mascara);"
                        id="dom_noit" name="dom_noit" maxlength="29" ></td>
                    </tr>
                  </table>
                  <div class="col-md-2">
                      <br>
      ...
      echo '
              <form action="acao_horario_variado.php" method="POST">  
                <div class="box-body table-responsive no-padding">
                  ...
                  d-2">
                    <br>
                     <button type="button" id="c_edicao" class="btn btn-danger pull-left" onclick="C_edicao()" 
    
v=v.replace(/(\3015})(\d)/g,3$4$2-");
  v=v.replace(/25\d{9})(\d)/3,"41:$2");
  v=v.replace(/20\d{4})(\d)/3,"$1h4a $2");
  v=v.replace(/18\d{2})(\d)/3,"41:$2");style="display:none;"> Cancelar Edição </button> 
                  </div>
