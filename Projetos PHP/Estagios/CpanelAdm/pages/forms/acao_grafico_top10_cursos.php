...
$ano = date('Y');
$sql1 = mysql_query("SELECT cur.curso AS nome_curso, Count(tc.id_curso) AS qtd FROM termo_compromisso tc LEFT JOIN cursos cur ON (tc.id_curso=cur.id_curso) WHERE SUBSTRING(dt_inicio, 7, 4) = '$ano' GROUP BY cur.curso ORDER BY qtd DESC LIMIT 0,10");
...
// Organiza Gráfico -----------------------------
$plot->SetTitle(utf8_decode('TOP 10 CURSOS - '.$ano));
