...
<head>
  ...
  <script type="text/javascript">
    function Enviar(opc){
      if(opc == 1){
      document.form.action = "acao_consulta_customizada5.php";
      document.form.submit();
      }
      if(opc == 2){
      document.form.action = "acao_consulta_customizada_xls5.php";
      document.form.submit();
      }
    }
  </script>
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <center>
                  ...
                  <h3 class="box-title">CONSULTAS CUSTOMIZADAS (VAGAS DE ESTÁGIOS):</h3>
                </center>
              </div>
              <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon right">
                    DE: <input  type="text" name="data" placeholder="EX.: 2016" class="form-control" />   
                  </div>
                </div>
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon left">
                    <input type="radio" name="opt" value="centro"/> CENTRO
                    <br>    
                    <input type="radio" name="opt" value="ano"/> TOTAL DO ANO
                    <br>
                  </div>
                </div>
