              ...
              <div class="box box-primary">
                <div class="form-group">
                  <div class="box-header with-border">
                   <h3 class="box-title">Atualizar Setor UFC</h3>
                   </div>
                  <div class="box-body">
...
include("../../../conn.php");
mysql_select_db('estagios');
 if(isset($_POST['setorbtn'])){

// Recebe o valor enviado
$valor = utf8_decode($_POST['setor']);
 
// Procura titulos no banco relacionados ao valor
$sql = mysql_query("SELECT * FROM Setor WHERE nome_setor LIKE '$valor'");
...
if($resulatdo != 0){
 ...
 $id_setor=$noticias->id_setor;

        if ($id_setor!=null) {
  echo utf8_encode('<form action="acao_atualizar_setor.php" method="POST">
                                  ...
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="nome_setor" style="text-transform:uppercase" class="form-control" value="'.$noticias->nome_setor.'">
                                          </div>
                                  </div>
  
                                  <input type="hidden" name="id_setor" value="'.$noticias->id_setor.'"/>
                                  <button type="submit" id="mostrar()" name="setorbtn2" class="btn btn-primary pull-left">Salvar</button>
                                  </form>
                                     <a href="setor.php"><button type="submit" class="btn btn-danger pull-right">Cancelar</button></a>');
