...
<div class="content-wrapper">
    ...
    <div class="content">
      ...
      <div class="row">
        ...
        $sql = mysql_query("SELECT * FROM usuarios_agencia WHERE tipo_usuario='aluno' AND status='Pendente'");
          ...
          echo'<br>
                <div class="box box-primary">
                  <div class="box-header">
                    <h3 class="box-title">Alunos Pendentes</h3>
                  </div>';
            ...
            $matricula = $noticias['login'];
            $sql2 = mysql_query("SELECT * FROM alunos WHERE matricula LIKE '$matricula'");
            ...
            echo utf8_encode('<form method="POST">
                      <tr>
                        ...
                        <input type="hidden" name="email" value="'.$noticias2['email'].'">
                        <input type="hidden" name="id_user" value="'.$noticias['id_user'].'">
                        <input type="hidden" name="login" value="'.$noticias['login'].'">
                      </tr></form>');
            }
               echo '</table>
                  </div>
        ...
        mysql_select_db('estagios');
          ...
          if(isset($_POST['btn'])){
            ...
            /* echo '<script> alert("Autorizado com Sucesso!".$id_user); </script>'; */
            if ($up!=0) echo '<script> alert("Autorizado com Sucesso!"); </script>';
            echo '<script> window.location="permissoes_alunos.php" </script>';
          }
        ?>
        <?php
        require ('../../../conn.php');
        mysql_select_db('estagios');
          ...
          if(isset($_POST['btnexc'])){
            ...
            $up = mysql_query("DELETE FROM usuarios_agencia WHERE login LIKE '".$matricula."'"); 
