...
$sql = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%$valor%' and tipo_termo like 'T.A' ");
...
$sql1 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%01-$valor%' and tipo_termo like 'T.A'");
...
$sql2 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%02-$valor%' and tipo_termo like 'T.A'");
...
$sql3 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%03-$valor%' and tipo_termo like 'T.A'");
...
$sql4 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%04-$valor%' and tipo_termo like 'T.A'");
...
$sql5 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%05-$valor%' and tipo_termo like 'T.A'");
...
$sql6 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%06-$valor%' and tipo_termo like 'T.A'");
...
$sql7 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%07-$valor%' and tipo_termo like 'T.A'");
...
$sql8 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%08-$valor%' and tipo_termo like 'T.A'");
...
$sql9 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%09-$valor%' and tipo_termo like 'T.A'");
...
$sql10 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%10-$valor%' and tipo_termo like 'T.A'");
...
$sql11 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%11-$valor%' and tipo_termo like 'T.A'");
...
$sql12 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%12-$valor%' and tipo_termo like 'T.A'");
