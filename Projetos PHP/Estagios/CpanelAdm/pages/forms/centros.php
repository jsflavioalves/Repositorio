...
<head>
  ...
  <title>AgÃªncia de EstÃ¡gio | Centros</title>
  ...
  function completarcentro() {
          
        
            $(document).ready(function(){
              $('#centro').autocomplete(
              { 
                source: "search_atual_centro.php",
                minLength: 1,
                delay: 0
              });
    ...
    <div class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Inserir Novo Centro</h3>
        </div>
        <!--PARTE QUE INSERE UM CENTRO NOVO CASO NÃƒO SEJA CADASTRADO-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Nome do Centro</label>
                <form action="acao_inserir_centro.php" method="POST">
                  <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-user-plus"></i></div>
                      <input type="text" class="form-control" name="nome" style="text-transform:uppercase" placeholder="Nome do Centro">
                  </div>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Atualizar Centro</h3>
        </div>
        <!--PARTE QUE ATUALIZA UM CENTRO POR MEIO DE PESQUISA AUTOCOMPLETE E FORMULÃ�RIO-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                <form action="page_atualizar_centro.php" method="POST">
                  <div class="form-group">
                    <label>Escolha um centro para atualizar</label>
                    <input id="centro" name="centro" onkeypress="completarcentro();" type="text" style="text-transform:uppercase" placeholder="Nome do centro" class="form-control" /></br>
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-primary pull-right" name="centrobtn" style="float: right; display:block;">Atualizar</button>
                    </div>
                  </div>
                </form>
              </div>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Excluir Centro</h3>
        </div>
        <!--PARTE QUE EXCLUI UM CENTRO DE ACORDO COM A ESCOLHA FEITA-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <form action="acao_deleta_centro.php" method="POST">
                  <label>Selecione um centro para excluir</label>
                  <select class="form-control select2" name="CD_CENTRO" style="width: 100%;">
                    <?php 
                      require('../../../conn.php');

                      $consulta = mysqli_query($conn,"SELECT * FROM centros");
