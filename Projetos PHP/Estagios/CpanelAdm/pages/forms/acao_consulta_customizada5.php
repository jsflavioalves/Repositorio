...
while($z <= 3){
	$ano = $dt_inicio-$z;
		...
		echo '<tr>';
		echo '<td colspan="2" style="color:green;"><center><b>Relatório Vagas de Estágio - Centro - '.$ano.'</b></center></td>';
		echo '</tr>';
		echo '<tr>';
		echo '<td style="width:450px; text-align:center;"><b>Centro</b></td>';
		echo '<td style="width:200px; text-align:center;"><b>Quantidade de Vagas</b></td>';
		echo '</tr>';
	...
	while($array1 = mysql_fetch_array($busca1)){
		...
		if($nome_centro ==  ""){
			...
			echo '<tr>';
			echo '<td style="text-align:center;">'.utf8_encode($nome_centro).'</td>';
			echo '<td style="text-align:center;">'.$quantidade.'</td>';
			echo '</tr>';
		}
	}
...
while($z <= 3){
	$ano = $dt_inicio-$z;
		echo '<tr>';
		echo '<td colspan="2" style="color:green;"><center><b>Relatório Vagas de Estágio - Mês - '.$ano.'</b></center></td>';
		echo '</tr>';
		echo '<tr>';
