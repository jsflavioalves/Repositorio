...
<head>
  ...
  function completarsetor() {
          
        
            $(document).ready(function(){
              $('#setor').autocomplete(
              { 
                source: "search_atual_setor.php",
                minLength: 1,
                delay: 0
              });
    ...
    <div class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Inserir Novo Setor</h3>
        </div>
        <!--PARTE QUE INSERE UM SETOR NOVO CASO NÃO SEJA CADASTRADO-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Nome do Setor</label>
                <form action="acao_inserir_setor.php" method="POST">
                  <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-user-plus"></i></div>
                      <input type="text" class="form-control" name="nome" style="text-transform:uppercase" placeholder="Nome do Setor">
                  </div>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Atualizar Setor </h3>
        </div>
        <!--PARTE QUE ATUALIZA UM SETOR POR MEIO DE PESQUISA AUTOCOMPLETE E FORMULÁRIO-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                <form action="page_atualizar_setor.php" method="POST">
                  <div class="form-group">
                    <label>Escolha um setor para atualizar</label>
                    <input id="setor" name="setor" onkeypress="completarsetor();" type="text" style="text-transform:uppercase" placeholder="Nome do setor" class="form-control" /></br>
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-primary pull-right" name="setorbtn" style="float: right; display:block;">Atualizar</button>
                    </div>
                  </div>
                </form>
              </div>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Excluir Setor</h3>
        </div>
        <!--PARTE QUE EXCLUI UM SETOR DE ACORDO COM A ESCOLHA FEITA-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <form action="acao_deleta_setor.php" method="POST">
                  <label>Selecione um setor para excluir</label>
                  <select class="form-control select2" name="id_setor" style="width: 100%;">
                    <?php 
                      require('../../../conn.php');

                      $consulta = mysql_query("SELECT * FROM Setor");
                      echo $result = mysql_num_rows($consulta);

                      while ($sql = mysql_fetch_array($consulta)) {
                        $id_setor = $sql['id_setor'];
                        $nome_setor = $sql['nome_setor'];

                        echo utf8_encode('<option value="'.$id_setor.'">'.$nome_setor.'</option>');
                      }
                     ?>
                  </select>
                  <div class="col-md-12"><br>
