            ...
            <section class="content">
              ...
              <div class="box box-primary">
                <div class="form-group">
                  ...
                  <h3 class="box-title">Atualizar Agente de Integração</h3>
                  </div>
                  <div class="box-body">
<!--AQUI IRA RECEBER O NOME DO AGENTE DE INTEGRACAO QUE FOI ESCOLHIDO PARA ATUALIZAR SE ESTIVER CADASTRADO NA TABELA DE DADOS-->
<?php
// Incluir aquivo de conexão
include("../../../conn.php");
mysql_select_db('estagios');
 if(isset($_POST['agentebtn'])){

// Recebe o valor enviado
$valor = utf8_decode($_POST['agente']);
...
if($resulatdo != 0){
 ...
 $CD_AGENTE=$noticias->CD_AGENTE;

        if ($CD_AGENTE!=null) {

  
  echo utf8_encode('<form action="acao_atualizar_agente.php" method="POST">
    <label id="mostrar_div1">Nome do Agente</label>
    <div class="form-group">
           <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-user-plus"></i>
                  </div>
                  <input type="text" id="inputName" onclick="btn();" style="text-transform:uppercase" class="form-control" name="nm_agente" value="'.$noticias->NM_AGENTE.'" placeholder="Nome do Agente" >
                </div>
    </div>
    ...
    <label id="mostrar_div1">Data Fim</label>
       <div class="form-group" id="mostrar_div2">
         ...
         <div class="form-group" id="mostrar_div3" >

                <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-exclamation-triangle"></i>
                  </div>
                  <input type="text" id="inputName" onclick="btn();" class="form-control" name="obs" value="'.$noticias->TX_OBS.'"  placeholder="Observacao" style="text-transform:uppercase">
                </div>
        </div>
            <input type="hidden" name="cd_agente" value="'.$noticias->CD_AGENTE.'"/>
            
                <button type="submit" id="mostrar_div4" class="btn btn-primary pull-left">Salvar</button>
              </form>
             <a href="agente.php"><button type="submit" class="btn btn-danger pull-right">Cancelar</button></a>          
    </div>');  
}
}
if ($resulatdo == 0) {
