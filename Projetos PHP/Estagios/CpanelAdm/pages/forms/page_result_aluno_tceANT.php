...
// Uso a substr para tirar o CNPJ do nome da concedente
$nome_concedente_nn = substr($nome_concedente_nn,0,strpos($nome_concedente_nn,"CNPJ:"));
...
$conta11 = mysql_num_rows($sql11);
  ...
  if($conta11 == 0){
    echo '<script> alert("VERIFIQUE NOME DA CONCEDENTE!".$nome_concedente_nn); </script>';
                   ...
                   echo'<div class="box-body table-responsive no-padding">
                          <table class="table table-hover">
                            <tr>
                              ...
                              <th>PERÍODO_RELATÓRIO 01</th>
                              <th>PERÍODO_RELATÓRIO 02</th>
                              <th>PERÍODO_RELATÓRIO 03</th>
                              <th>PERÍODO_RELATÓRIO 04</th>
                              <th>AGENTE</th>
