...
if($resulatdo != 0){
//while ($noticias = @mysql_fetch_array($sql)){echo utf8_encode('<a id="nome" href="atualizar_conv_and_mostra.php?"'.
//$nomeemp = "";
//while ($noticias = @mysql_fetch_array($sql)){
  //echo utf8_encode('<a onclick="guarda_nome();" id="nome"><div>' . @$noticias['interessado'] . '</div></a>');}
  $noticias = @mysql_fetch_array($sql);
  
  //echo 'EMPRESA:'. $nomeemp;

  echo '<div id="dasinp" onclick="siim();" style="display:Block">';
  echo utf8_encode('<form action="acao_atualizar_conv_and.php" method="POST" name="form" id="form" onSubmit="">
                    ...
                    <div class="form-group">
                            <div class="input-group">
                              ...
                              <input type="text" onclick="mostrar_salvar()" id="cnpj" onkeypress="cnpj2(cnpj)" maxlength="18" class="form-control" name="cnpj" value="'.$noticias['cnpj'].'">
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <center>
                            <br>
                            <p>Deseja formalizar o conv&ecirc;nio?</p>
                            SIM:  <input type="radio" id="sim" name="opt" value="sim" style="margin-right: 40px;">
                            N&AtildeO:  <input type="radio" id="nao" name="opt" value="nao">
                            </center>
                    </div>
        ...
        <input type="hidden" name="id_convenios_andamento" value="'.$noticias['id_convenios_andamento'].'"/>

                    <input type="submit" id="mostrar_div4" style="display:block;" class="btn btn-primary pull-left" value="Salvar"/>
        </form>
                    <a href="convenios_andamento.php"><button type="button" class="btn btn-danger pull-right">Cancelar</button></a>'); 
}
if ($resulatdo == 0) {
