  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary"  >
            ...
            <!--essa consulta nao faz parte das consultas padroes porque pesquisa apenas os dados da tabela-->
              <h3 class="box-title" style="width: 400px; float:left;">E-MAILS DE DÚVIDAS/SUGESTÕES</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding" id="divTable" style="height: 400px; overflow:auto; display:block;" >
              <table class="table table-hover" >
                ...
                <!--php que verifica os emails cadastradas e coloca dentro de uma tabela-->
                <!--esses emails são registrados na página contact.php, que está localizada junto com as paginas do site-->
                <?php 
                  require('../../../conn.php');

                  $consulta = mysql_query("SELECT * FROM email order by id_email DESC");

                  while($sql = mysql_fetch_array($consulta)){
                    $id_email = $sql['id_email'];
                    $nome = $sql['nome'];
                    $email = $sql['email'];
                    $assunto = $sql['assunto'];
                    ...
                    echo utf8_encode('
                      ...
                      <tr>
                            <td WIDTH=30>'.$id_email.'</td>
                            <td WIDTH=40>'.$nome.'</td>
                            <td WIDTH=40><a href="https://www.gmail.com" target="_blank">'.$email.'</a></td>
                            <td WIDTH=40>'.$assunto.'</td>
                            <td WIDTH=40 style="text-align: justify;"><label>'.$mensagem.'</label></td>
                            <td WIDTH=40>'.$data.'</td>
                            <td WIDTH=40>'.$hora.'</td>
                      </tr>
                           ');
      ...
      <div class="row">
        ...
        <!--modelo antigo de excluir um email quando se coloca o id que aparece na tabela-->
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Apagar E-mail</h3>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="form-group" id="btn_apagar" style="display: block;">
                <div class="form-group" id="pesquisa_apagar">
                  <div class="input-icon right" id="busca_apagar">
                      <!-- FUNÇÃO (funcs_apagar_email.js) E BUSCA (busca_apagar_email.php) -->
                      <input id="inputName" onkeyup="buscarNoticias_apagar_email(this.value)" type="number" placeholder="ID_EMAIL" class="form-control" />
                  </div> 
                  <form action="acao_deleta_email.php" enctype="multipart/form-data" method="POST">
...
<script src="../../dist/js/funcs_apagar_email.js"></script>
