...
<head>
  ...
  function completarpreceptor() {
          
        
            $(document).ready(function(){
              $('#prec').autocomplete(
              { 
                source: "search_preceptor.php",
                minLength: 1,
                delay: 0
              });
    ...
    <div class="content">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">PRECEPTORES</h3>
            </div>
            <!-- /.box-header -->
            ...
            <div class="box-body table-responsive no-padding" id="tabela" style="display: block;" >
              <table class="table table-hover">
                ...
                <?php 
                  ...
                  $consulta = mysql_query("SELECT * FROM preceptores ORDER BY id_preceptor DESC LIMIT 7");
                  $td=mysql_num_rows($consulta);

                  if ($td!=0) {
                    while ($sql = mysql_fetch_array($consulta)) {
                      $id_preceptor = $sql['id_preceptor'];
                      $nome = $sql['nome'];
                      $cpf = $sql['cpf'];
                  ...
                  if ($td==0) {
                    echo' <tr>
                            <td>Não existem preceptores cadastrados</td>
                          </tr>';
                  }
                 ?>
              </table>
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                <form action="page_atualizar_preceptor.php" method="POST">
                  <div class="form-group">
                    <input id="prec" name="prec" onkeypress="completarpreceptor();" type="text" style="text-transform:uppercase" placeholder="Nome/CPF" class="form-control" /><br>
                    <div class="col-md-12">
      ...
      <div class="col-md-6">
        <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Excluir Preceptor(a)</h3>
        </div>
        <!--PARTE QUE EXCLUI UM PROFESSOR-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                <form action="acao_deleta_preceptor.php" method="POST">
                <select class="form-control select2" name="id_preceptor" style="width: 100%;">
                  <?php 
                    require('../../../conn.php');

                    $consulta = mysql_query("SELECT * FROM preceptores");
                    echo $result = mysql_num_rows($consulta);

                    while ($sql = mysql_fetch_array($consulta)) {
                      $id_professor = $sql['id_preceptor'];
                      $nome = $sql['nome'];
                      $cpf = $sql['cpf'];

                      echo utf8_encode('<option value="'.$id_preceptor.'">'.$nome.' - '.$cpf.'</option>');
                    }
                   ?>
                </select><br><br>
                 <div class="col-md-12">
