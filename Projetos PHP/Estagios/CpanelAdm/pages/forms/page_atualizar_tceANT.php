                   ...
                   echo utf8_encode('
                    ...
                    <div class="form-group">
                            <div class="input-group">
                              ...
                              <input type="text" id="inputName"  class="form-control" name="data_relatorio_1" value="'.$noticias->data_relatorio_1.'" id="data" size="60" maxlength="50" >
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                            <div class="input-group">
                              ...
                              <input type="text" id="inputName"  class="form-control" name="data_relatorio_2" value="'.$noticias->data_relatorio_2.'" id="data" size="60" maxlength="50" >
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                            <div class="input-group">
                              ...
                              <input type="text" id="inputName"  class="form-control" name="data_relatorio_3" value="'.$noticias->data_relatorio_3.'" id="data" size="60" maxlength="50" >
                            </div>
                    </div>
                    ...
                    <div class="form-group">
                            <div class="input-group">
                              ...
                              <input type="text" id="inputName"  class="form-control" name="data_relatorio_4" value="'.$noticias->data_relatorio_4.'" id="data" size="60" maxlength="50" >
                            </div>
                    </div>
                    <label> Agente </label>
                    <div class="form-group">
