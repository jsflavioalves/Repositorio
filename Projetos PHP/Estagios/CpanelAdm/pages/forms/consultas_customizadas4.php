...
<head>
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function()
    {
      ...
      {
        source: "search_empresas_estagios.php",
        minLength: 1
      });
    ...
    function Enviar(opc){
      ...
      document.form.action = "acao_consulta_customizada4.php";
      document.form.submit();
      }
      if(opc == 2){
      document.form.action = "acao_consulta_customizada_xls4.php";
      document.form.submit();
      }
    }
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <center>
                  ...
                  <h3 class="box-title">CONSULTAS CUSTOMIZADAS (RELATÓRIO DE ERROS):</h3>
                </center>
              </div>
              <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon left">
                    <input type="radio" name="opt" value="emp_cnpj"/> EMPRESAS SEM CNPJ
                    <br>   
                    <input type="radio" name="opt" value="emp_duplicadas"/> EMPRESAS DUPLICADAS
                    <br>
                    <input type="radio" name="opt" value="conv_duplicados"/> CONVÊNIOS DUPLICADOS
                    <br>
                    <input type="radio" name="opt" value="alunos_duplicados"/> ALUNOS DUPLICADOS
                    <br>    
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <input type="submit" name="btn_xls" value="Gerar .xls" class="btn btn-success pull-left" onClick="Enviar(2);" >
                </div>
