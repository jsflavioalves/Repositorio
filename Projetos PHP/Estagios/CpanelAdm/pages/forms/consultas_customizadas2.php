...
<head>
  ...
  <script type="text/javascript">
    function Enviar(opc){
      if(opc == 1){
      document.form.action = "acao_consulta_customizada2.php";
      document.form.submit();
      }
      if(opc == 2){
      document.form.action = "acao_consulta_customizada_xls2.php";
      document.form.submit();
      }
    }
  </script>
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <center>
                  ...
                  <h3 class="box-title">CONSULTAS CUSTOMIZADAS (CONVÊNIOS):</h3>
                </center>
              </div>
              <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon right">
                    DE: <input  type="text" name="dt_inicio" placeholder="EX.: 2016" class="form-control" />   
                  </div>
                </div>
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon right">
                    ATÉ: <input  type="text" name="dt_fim" placeholder="EX.: 2017" class="form-control" />
                  </div>
                </div>
                -->
                ...
                <div class="col-md-6" class="form-group">
                  <div class="input-icon left">
                    <input type="radio" name="opt" value="tipo_empresa"/> TIPO DE CONCEDENTE
                    <br>    
                    <input type="radio" name="opt" value="mes"/> MÊS
                    <br>
                    <input type="radio" name="opt" value="total"/> TOTAL
                    <br>  
                    <input type="radio" name="opt" value="vigentes"/> VIGENTES
                    <br>   
                  </div>
                </div>
