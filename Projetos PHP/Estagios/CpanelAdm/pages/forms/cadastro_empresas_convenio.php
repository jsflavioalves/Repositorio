  ...
  <script type="text/javascript">
    ...
    function completar_busca_conv() {
        ...
        function completar_busca_conv_atu() {
         ...
         function completar_busca_conv_del() {
      ...
      <section class="content">
        <div class="row">      
          <div class="col-xs-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title" id="nome_empresa">Inserir Convênio - Dados da Empresa </h3>
              </div>
              <div class="box-body">
              <div class="form-group" id="btn" style="display: block;">
              <form action="page_result_convenio.php" method="POST">
                <div class="form-group" id="pesquisa">
                    <div class="input-icon right" id="busca">
                      <div class="col-md-12">
                          <input id="nome" onkeypress="completar_busca_conv();" type="text" name="nome" placeholder="Nome ou CNPJ da Empresa" class="form-control" /><br>
                       
                          <div class="col-md-8"></div>
                          <div class="col-md-4">
                            <button type="submit" class="btn btn-block btn-primary" name="btna" style="float: right; display:block;">Inserir</button>
                          </div>
                        </div>
                      </div>
                    <!--<form action="inserir_empresa_convenio.php" method="POST">
          ...
          <div class="col-md-6">
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <form action="page_result_processo.php" method="POST">
                    <div class="form-group" id="pesquisa">
                      <div class="input-icon right" id="busca_convenio">
                        <div class="col-md-12">
                          <input id="nome1" onkeypress="completar_busca_conv_atu();" type="text" name="nome1" placeholder="Nome ou CNPJ da Empresa" class="form-control" /><br>
                       
                          <div class="col-md-8"></div>
                          <div class="col-md-4">
                            <button type="submit" class="btn btn-block btn-primary" name="btna1" style="float: right; display:block;">Atualizar</button>
                          </div>
                        </div>
                      </div>
                      <!--<form action="atualizar_empresa_convenio.php" method="POST">
                      <div id="resultado_convenio"></div>
                      </form>-->
                    </div> 
                  </form>
                </div>
          ...
          <div class="col-md-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Excluir Processo de Convênio</h3>
              </div>
              <div class="box-body">
                <div class="form-group" id="btn3" style="display: block;">
                <form action="page_result_processo_deletar.php" method="POST">
                    <div class="form-group" id="pesquisa">
                      <div class="input-icon right" id="busca_convenio">
                        <div class="col-md-12">
                          <input id="nome2" onkeypress="completar_busca_conv_del();" type="text" name="nome2" placeholder="Nome ou CNPJ da Empresa" class="form-control" /><br>
                       
                          <div class="col-md-8"></div>
                          <div class="col-md-4">
                            <button type="submit" class="btn btn-block btn-danger" name="btna2" style="float: right; display:block;">Excluir</button>
                          </div>
                        </div>
                      </div>
                      <!--<form action="atualizar_empresa_convenio.php" method="POST">
          ...
          <div class="col-md-6">
            <div class="box box-primary">
              <div class="box-header with-border">
               <h3 class="box-title">Consultar Convênios de Uma Empresa</h3>
              </div>
              <div class="box-body">
                <div class="form-group" id="btn3" style="display: block;">
                <form action="acao_gerar_conv_xls.php" method="POST">
                    <div class="form-group" id="pesquisa">
                      <div class="input-icon right" id="busca_convenio">
                        <div class="col-md-12">
                          <input type="text" name="ano" placeholder="Ano dos Convênios:EX.: 2017" maxlength="4" class="form-control"><br>
                       
                          <div class="col-md-8"></div>
                          <div class="col-md-4">
                            <button type="submit" class="btn btn-block btn-success" name="btn_xls1"> Gerar .xls</button>
                          </div>
                        </div>
                      </div>
                      <!--<form action="atualizar_empresa_convenio.php" method="POST">
