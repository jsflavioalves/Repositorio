          ...
          echo'<br>
                <div class="box box-primary">
                  <div class="box-header">
                    <h3 class="box-title">Convênios vencidos</h3>
            ...
            $partes = explode("-", $dt_fim);
                    ...
                    $total1 = $dia_atual - $dia_dt;
                    $total2 = $mes_atual - $mes_dt;
                    $total3 = $ano_atual - $ano_dt;
                    ...
                    if($dia_dt < $dia_atual AND $mes_dt < $mes_atual AND $ano_dt < $ano_atual){
                      echo utf8_encode('<tr>
                        ...
                        <td><input type="submit" value="'.$total3.' - '.$total2.' - '.$total1.'" style="width:120px;" class="btn btn-danger"></td>
                      </tr>
