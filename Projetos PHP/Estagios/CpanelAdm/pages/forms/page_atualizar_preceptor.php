              ...
              <div class="box box-primary">
                <div class="form-group">
                  <div class="box-header with-border">
                   <h3 class="box-title">Atualizar Preceptor(a)</h3>
                   </div>
                  <div class="box-body">
...
$valor = utf8_decode($_POST['prec']);
 
// Procura titulos no banco relacionados ao valor
$sql = mysql_query("SELECT * FROM preceptores WHERE nome LIKE '$valor' OR cpf LIKE '$valor'");
...
if($resulatdo != 0){
 ...
 $id_preceptor=$noticias->id_preceptor;

        if ($id_preceptor!=null) {
  echo utf8_encode('<form action="acao_atualizar_preceptor.php" method="POST">
                                  <label> Nome </label>
                                  <div class="form-group">
                                  ...
                                  <input type="hidden" name="id_preceptor" value="'.$noticias->id_preceptor.'"/><br>
                                  <button type="submit" id="mostrar()" name="siapebtn2" class="btn btn-primary pull-left">Salvar</button>
                                  </form>
                                     <a href="preceptores.php"><button type="submit" class="btn btn-danger pull-right">Cancelar</button></a>');
