...
mysql_select_db('estagios');
	...
	$busca_id_convenio = mysql_query("SELECT * FROM termo_compromisso2");
	while($array2 = mysql_fetch_array($busca_id_convenio)) {
		$busca_id = $array2['nome']; 	 	
		//echo $busca_id."<br>";
		...
		while($array3 = mysql_fetch_array($busca_nomes)) {
			...
			$atualizar = mysql_query("UPDATE termo_compromisso2 SET nome='$id_correto' WHERE nome LIKE '$id_teste'");
			//$deletar = mysql_query("DELETE FROM empresas2 WHERE CD_EMPRESA != '$id_correto'");
