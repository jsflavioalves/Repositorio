...
function completar() {
      			...
      			$(document).ready(function(){
      				$('#nome').autocomplete(
              {	
       				  source: "search_atual_empresa.php",
        			  minLength: 1,
                delay: 0
      			  });
...
function completar1() {
            ...
            $(document).ready(function(){
              $('#nome1').autocomplete(
              { 
                source: "search_excluir_empresa.php",
                minLength: 1,
                delay: 0
              });
        ...
        function completar2() {
            ...
            $(document).ready(function(){
              $('#nome2').autocomplete(
              { 
                source: "search_consultar_empresa_2.php",
                minLength: 1,
                delay: 0
              });
...
<div class="wrapper">
  ...
  <!--codigo do cadastro de empresas_agentes-->
  <!--pagina também tem a capacidade de consultar, atualizar e excluir empresa agente-->
    <!-- Main content -->
    <div class="content">
    ...
    <div class="box box-primary collapsed-box">
                      ...
                      <div class="box-body">
                        <div class="form-group" id="btn" style="display: block;">
                              <form action="page_result_tds_empresas.php" method="POST">
                                <div class="form-group" id="pesquisa">
                                    <div class="input-icon right" id="busca">
                                        <div class="col-md-12">
                                           <input id="nome2" onkeypress="completar2()" type="text" name="nome2" placeholder="Procurar Empresa" class="form-control" /><br>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <form action="acao_inserir_empresa_agente.php" method="POST">
            <div class="box-body">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label>Cidade-UF</label>
                      <input type="text" name="cidade_uf" class="form-control" required>
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
            ...
            <div class="box-footer">
              <div class="col-md-12">
                ...
                <div class="col-md-2">
                  <input type="submit" class="btn btn-block btn-primary" style="float: right; display:block;" value="Inserir">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6">
            <div class="box box-primary collapsed-box">
              ...
              <div class="box-body">
                ...
                <form action="page_atualizar_empresa.php" method="POST">
                  <div class="form-group" id="pesquisa">
                    <div class="input-icon right" id="busca">
                      <!-- FUNÇÃO (funcs_empresa10.js) E BUSCA (busca_empresa.php) -->
                      <div class="col-md-12">
                      	<input id="nome" type="text" name="nome" onkeypress="completar();" placeholder="Nome ou CNPJ da Empresa" class="form-control" /><br>
            ...
            <div class="box box-primary collapsed-box">
              ...
              <div class="box-body">
                <div class="form-group" id="ok_conv" style="display: block;">
                 <form action="acao_deleta_empresa.php" method="POST">
                  <div class="form-group" id="pesquisa2">
                    ...
                    <!-- FUNÇÃO (funcs_empresadel.js) E BUSCA (busca_empresadel.php) -->
                        <div class="col-md-12">
                        <input id="nome1" type="text" name="nome1" onkeypress="completar1();" placeholder="Nome da Empresa" class="form-control" /><br>
                       
                        <div class="col-md-8">
                        </div>
                          <div class="col-md-4">
                            <input type="submit" class="btn btn-block btn-danger" name="btna" style="float: right; display:block;" value="Excluir">
                          </div>
                      </div> 
                    </div>
