                  ...
                  <div class="row">
                    <div class="col-xs-12"><br>
                      <div class="box box-primary">
                        ...
                        // Procura titulos na tabela termo_compromisso relacionados ao valor da matricula do aluno
                        $sql3 = mysqli_query($conn,"SELECT * FROM termo_compromisso WHERE matricula_aluno LIKE '$noticias0->matricula' ");

                        // BUSCAR O ID DO CURSO
                        session_start();

                        // Procura titulos na tabela alunos relacionados ao valor do nome ou da matricula do aluno
                        $busca_curso = mysqli_query($conn,"SELECT * FROM alunos WHERE nome LIKE '$noticias0->nome' AND matricula LIKE '$noticias0->matricula'");
                        ...
                        $sql2 = mysqli_query($conn,"SELECT variavel FROM termo_compromisso WHERE id_termo_compromisso LIKE '$noticias0->id_termo_compromisso'");
                             ...
                             while($noticias3=@mysqli_fetch_array($sql3)){ 
                                ...
                                $empresa = $noticias3['nome'];
                                  ...
                                  $noticias_empresa = @mysqli_fetch_array($sql_empresa);
                                    ...
                                    $sql_setor = mysqli_query($conn,"SELECT * FROM Setor WHERE id_setor LIKE '$setor' ORDER BY nome_setor ASC");
                                    ...
                                    $noticias_setor = @mysqli_fetch_array($sql_setor);
                                      ...
                                      $sq4 = mysqli_query($conn,"SELECT * FROM agentes WHERE CD_AGENTE LIKE '$agente'");
          ...
          echo utf8_encode('<br>
                  <div class="row">
                    <div class="col-xs-12"><br>
                      ...
                      $sql6 = mysqli_query($conn,"SELECT * FROM termo_compromisso where matricula_aluno like '$noticias0->matricula'  ORDER BY id_termo_compromisso ASC ");  
                  ...
                  <div class="row">
                                              ...
                                              <select class="form-control select2" name="tce_atu" style="width: 100%;" required>
                                                  <?php 
                                                    require('../../../conn.php');
                                                      ...
                                                      // Procura titulos no banco relacionados ao valor
                                                      $sql = mysqli_query($conn,"SELECT * FROM alunos WHERE nome LIKE '$valor1' or matricula LIKE '$valor1'");
                                                      ...
                                                      if($resulatdo != 0){
                                                        ...
                                                        $consulta = mysqli_query($conn,"SELECT * FROM termo_compromisso WHERE matricula_aluno LIKE '$noticias2->matricula' ORDER BY id_termo_compromisso ASC");
                        ...
                        <div class="col-md-6">
                          ...
                          //         mysqli_select_db('estagios');
                                  ...
                                  if($resulatdo != 0){
                                    $noticias2 = @mysqli_fetch_object($sql);
                                    $sql2 = mysqli_query($conn,"SELECT * FROM termo_compromisso WHERE matricula_aluno LIKE '$noticias2->matricula'");
                                    ...
                                    echo '      <br>
                                                <table class="table table-hover">
                                                  ...
                                                  while($noticias1 = mysqli_fetch_array($sql2)){
                                                      ...
                                                      $sql6 = mysqli_query($conn,"SELECT * FROM empresas WHERE CD_EMPRESA LIKE '$nome_emp' ORDER BY nome ASC ");
                        ...
                        $consulta = mysqli_query($conn,"SELECT * FROM termo_compromisso WHERE matricula_aluno LIKE '$noticias2->matricula' AND variavel LIKE '$sim' AND variavel != '' ORDER BY id_termo_compromisso ASC");
