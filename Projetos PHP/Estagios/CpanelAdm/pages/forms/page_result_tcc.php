  ...
  <script>
    ...
    function abreResposta(formulario) {
     ...
     function disa(){
      ...
      var mudar = document.getElementById("hv").style.display = 'none';  
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-6">
              <!-- Formulário de Cunsulta à Tabela "Termos_c_coletivo" -->
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group-addon"><i class="fa fa-barcode"></i></div>
                                <input type="text" name="cd_tcc" id="tcc" onclick="complete_tcc()" placeholder="Codigo do TCC" class="form-control" />
                              </div>
                            </div>
                          </div>                          
                     ...
                     echo '<div class="col-md-6">
                              ...
                              <div class="box box-primary collapsed-box">
                                <div class="box-header with-border">
                                  <h3 class="box-title">Atualizar TCC</h3>
                                    <div class="box-tools pull-right">
                                      <button type="button" class="btn btn-box-tool" data-widget="collapse" onclick="disa()" ><i class="fa fa-plus"></i>
                                      </button>
                                    </div>
                                </div>';
                      echo '      <div class="box-body">
                            ...
                            echo utf8_encode('
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                  <div class="input-group">
                                                    ...
                                                    <input type="text" id="inputName" class="form-control" value="'.$obj->siape.'" name="siape">
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="col-md-6">
                                        ...
                                        echo utf8_encode(' <div class="col-md-12">
                                                <label> Agente </label>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                  <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-exclamation-triangle"></i></div>
                                                    <input type="text" id="inputName" class="form-control" value="'.$obj->prof_orientador.'" name="prof_n" >
                                                  </div>
                                                </div>');
                              ...
                              echo utf8_encode('<label>Concedente</label>
                                                <div class="form-group">
                                          ...
                                          <div class="col-xs-6" id="dados_aluno">
                                            <div class="box box-primary">
                                              <div class="box-header">
                                                  <center><div class="note2 note-danger2"><h4 class="box-heading2"><Strong><font color="red">AVISO! </font></Strong></h4>
...
echo              '<form action="acao_preencher_tcc.php" method="POST" target="_blank">
...
echo                      '</table>
                  ...
                  ';
                     ...
                     echo'  <div class="col-xs-12" id="dados_aluno"><br>
                              <div class="box box-primary">
                                <div class="box-header">
...
echo '                      <input type="hidden" class="form-control" name="cd_tcc" value="'.$objcdt->cd_tcc.'">
...
?>
<?php
                 echo      '<div class="col-md-12" id="div_" style="display:block;">
                              <div class="col-md-2">
...
<?php 
                        ...
                        ?>
                          <div class="col-md-6">
                          <div class="box box-primary collapsed-box" id="hv" style="display: block;">
                            <div class="box-header with-border">
                                            ...
                                            <div class="col-md-12">
                                                  ...
                                                  <?php 
                                                    require('../../../conn.php');
                                                      ...
                                                      $cd_tcc_hv = $_POST['cd_tcc'];
                                                      $sim = "SIM";
                                                       
                                                      // Procura titulos no banco relacionados ao valor
                                                      
                                                      $resulatdo = mysql_query("SELECT * FROM termo_compromisso WHERE cd_tcc LIKE '$cd_tcc_hv' AND variavel LIKE '$sim' ORDER BY id_termo_compromisso ASC");

                                              
                                                      // Exibe todos os valores encontrados
                                                      $cont = 1;
                                                      $opiptcctodos = " "; 
                                                      while ($sql = mysql_fetch_array($resulatdo)) {
                                                          $id_termo_compromisso = $sql['id_termo_compromisso'];

                                                          echo utf8_encode('<input type="checkbox" name="opt'.$id_termo_compromisso.'" value="'.$id_termo_compromisso.'">'. ' '.$id_termo_compromisso.' ');
                                                          $opidtcc = array($cont => $id_termo_compromisso);
                                                          $opiptcctodos=$opiptcctodos . " ". $opidtcc[$cont];
                                                          $cont = $cont + 1;
                                                        }
                                                     echo '<input type="hidden" class="form-control" name="id_tce_hv" value="'.$opiptcctodos.'">';                                                   
                                                  ?>
