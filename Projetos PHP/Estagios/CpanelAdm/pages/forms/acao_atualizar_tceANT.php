...
// Limpa o nome, tirando a partir do CNPJ
$concedente_n = substr($concedente_n,0,strpos($concedente_n,"CNPJ:"));

$consultaempresa = mysql_query("SELECT * FROM empresas WHERE nome LIKE '$concedente_n'");
$cdempresa = mysql_fetch_object($consultaempresa);
$CD_EMPRESA = $cdempresa->CD_EMPRESA;
