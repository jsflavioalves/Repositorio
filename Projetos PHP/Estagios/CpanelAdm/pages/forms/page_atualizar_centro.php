...
<!--AQUI IRÁ RECEBER O NOME DO CENTRO QUE FOI ESCOLHIDO PARA ATUALIZAR SE ESTIVER CADASTRADO NA TABELA DE DADOS-->
<?php
// Incluir aquivo de conexão
include("../../../conn.php");
mysql_select_db('estagios');
 if(isset($_POST['centrobtn'])){

// Recebe o valor enviado
$valor = utf8_decode($_POST['centro']);
...
if($resulatdo != 0){
 ...
 $CD_CENTRO=$noticias->CD_CENTRO;
        ...
        if ($CD_CENTRO!=null) {
  echo utf8_encode('<form action="acao_atualizar_centro.php" method="POST">
                                  </br><label> Nome do Centro </label>
                                  <div class="form-group">
                                          <div class="input-group">
                                            ...
                                            <input type="text" onclick="mostrar()" name="nome_centro" style="text-transform:uppercase" class="form-control" value="'.$noticias->NM_CENTRO.'">
                                          </div>
                                  </div>
  
                                  <input type="hidden" name="id_centro" value="'.$noticias->CD_CENTRO.'"/>
                                  <button type="submit" id="mostrar()" name="centrobtn2" class="btn btn-primary pull-left">Salvar</button>
                                  </form>
                                     <a href="centros.php"><button type="submit" class="btn btn-danger pull-right">Cancelar</button></a>');
