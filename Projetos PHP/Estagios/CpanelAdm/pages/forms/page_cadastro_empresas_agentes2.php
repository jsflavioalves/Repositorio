        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Empresa não cadastrada, realize o cadastro:</h3>
            ...
            <div class="box-body">
              <div class="row" id="divForm" style="display:block;">
                <form action="acao_inserir_empresa_agente2.php" method="POST">
                <div class="col-md-6">
                  <div class="form-group">
                  <?php
                    session_start();
                    $empresa = utf8_encode($_SESSION['empresa']);
                    $cnpj = $_SESSION['cnpj'];
                 
                    echo '<label>Nome da Empresa:</label>
                      <input type="text" name="nome_empresa" class="form-control" value="'.$empresa.'" required>';
                     ?>
                  </div>
                  <div class="form-group">
                    <label>Endereço:</label>
                      <input type="text" name="endereco" class="form-control" required onfocus>
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
            ...
            <div class="box-footer">
              <div class="col-md-12">
                <div class="col-md-2 pull-left">
                  <a href="convenios_andamento.php"><button type="button" class="btn btn-block btn-danger" style="float: left; display:block;">CANCELAR</button></a>
                </div>
                <div class="col-md-2 pull-right">
                  <button type="submit" class="btn btn-block btn-success" id="btn10" onclick="mostrar();" style="float: right; display:block;">CADASTRAR</button>
                </div>
                </div>
              </div>
            </div>
