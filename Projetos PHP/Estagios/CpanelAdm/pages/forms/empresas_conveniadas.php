            ...
            <section class="content">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Empresas Conveniadas</h3>
                </div>
                <!-- /.box-header -->
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Nome ou CNPJ da Empresa</label>

                        <div class="form-group" id="pesquisa">
                            <div class="input-icon right" id="busca">
                            <!-- FUNÇÃO (funcs_empresas_adm.js) E BUSCA (page_result_empresas.php) -->
                                <input id="inputName" onkeyup="buscarNoticias(this.value)" type="text" placeholder="Nome ou CNPJ da Empresa" class="form-control" />
                            </div>
                            <br>
...
<!-- Page script -->
<script src="../../dist/js/funcs_empresas_adm.js"></script>
