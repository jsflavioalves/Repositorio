    ...
    <div class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Temos de Compromisso Sem Via UFC</h3>
        </div>
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
            <form action="acao_gerar_pdf_sem_via_ufc.php" target="_blank" method="POST">
                        <input id="ano" name="ano" type="text" style="text-transform:uppercase" placeholder="AAAA" class="form-control" maxlength="4" /></br>

                        <button type="submit" class="btn btn-primary pull-right"  name="semviabtn" style="float: right; display:block;">GERAR RELATÓRIO</button>
