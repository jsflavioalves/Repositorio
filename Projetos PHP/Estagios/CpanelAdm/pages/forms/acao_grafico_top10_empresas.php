...
$ano = date('Y');
$sql1 = mysql_query("SELECT emp.nome AS nome_empresa, Count(tc.nome) AS qtd FROM termo_compromisso tc LEFT JOIN empresas emp ON (tc.nome=emp.CD_EMPRESA) WHERE SUBSTRING(dt_inicio, 7, 4) = '$ano' GROUP BY emp.nome ORDER BY qtd DESC LIMIT 0,10");
...
// Organiza Gráfico -----------------------------
$plot->SetTitle(utf8_decode('TOP 10 EMPRESAS - '.$ano));
