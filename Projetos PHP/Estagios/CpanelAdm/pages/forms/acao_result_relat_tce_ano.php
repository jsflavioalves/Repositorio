...
$sql = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%$valor%'");
...
$sql1 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%01-$valor%'");
...
$sql2 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%02-$valor%'");
...
$sql3 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%03-$valor%'");
...
$sql4 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%04-$valor%'");
...
$sql5 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%05-$valor%'");
...
$sql6 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%06-$valor%'");
...
$sql7 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%07-$valor%'");
...
$sql8 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%08-$valor%'");
...
$sql9 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%09-$valor%'");
...
$sql10 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%10-$valor%'");
...
$sql11 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%11-$valor%'");
...
$sql12 = mysql_query("SELECT * FROM termo_compromisso WHERE dt_inicio LIKE '%12-$valor%'");
