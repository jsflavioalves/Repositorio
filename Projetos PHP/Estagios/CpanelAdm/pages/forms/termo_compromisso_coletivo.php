                              ...
                              <div class="col-md-2">
                                <label> Carga Horária</label>
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_2" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n2" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n4" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n5" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n6" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n7" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n9" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n10" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n11" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n12" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n13" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n14" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n15" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n16" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n17" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n18" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n19" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n20" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n22" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n24" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n25" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n26" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n27" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n29" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n30" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n31" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n32" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n33" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n34" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n35" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n36" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n37" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n38" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n39" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n40" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_41" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n41" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n42" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n43" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n44" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n45" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                   <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n46" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n47" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                 <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n48" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-2">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n49" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_50" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n50" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_52" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n52" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_54" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n54" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_55" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n55" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_56" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n56" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_57" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n57" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_59" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n59" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
                            ...
                            <div class="col-md-12" id="div_60" style="display:none;">
                              ...
                              <div class="col-md-2">
                                  <div class="form-group">
                                    <div class="input-group">
                                      <div class="input-group-addon"><i class="fa fa-clock-o"></i></div>
                                      <input type="text" id="inputName" class="form-control" name="cg_hrr_n60" id="hora" placeholder="CH" size="3" maxlength="3">
                                    </div>
                                  </div>
                              </div>
                              <div class="col-md-2">
