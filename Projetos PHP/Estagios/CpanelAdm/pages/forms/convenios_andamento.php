          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <div class="input-group input-group-sm" style="width: 150px; float:right;">
                <!-- FUNÇÃO (funcs_Conv_and.js) E BUSCA (page_result_Conv_and2.php) -->
            ...
            <div class="box-body table-responsive no-padding" id="tabela" style="display: block;" >
              <table class="table table-hover">
                ...
                <?php 
                  ...
                  $consulta = mysql_query("SELECT * FROM convenios_andamento WHERE retorno_prex = ' ' OR pendencia <> NULL ORDER BY dt_abertura ASC");
                 ...
                 <tr>
                  <td></td>
                  <form action="acao_inserir_conv_and.php" method="POST">
                  ...
                  <td><input type="text" class="form-control" placeholder="Pendência" name="pendencia"></td>
                  <td><button type="submit" name="btn2" class="btn btn-block btn-success">INSERIR</button></td>
                  </form>
                </tr>
              </table>
            </div>
      ...
      <div class="col-md-6">
          <div class="box box-primary collapsed-box">
            ...
            <div class="box-body">
              <div class="form-group" id="btn3" style="display: block;">
                <form action="page_atualizar_conv_and.php" method="POST">
                  <div class="form-group" id="pesquisa">
                    <div class="input-icon right" id="busca">
                        <div class="col-md-12">
                          <input id="nome" onkeypress="completar_conv_and();" type="text" name="interessado" placeholder="Nome do Convênio" class="form-control" /><br>
        ...
        <div class="col-md-6">
          <div class="box box-primary collapsed-box">
            ...
            <div class="box-body">
              <div class="form-group" id="btn3" style="display: block;">
                <form action="acao_deleta_conv_and.php" method="POST">
                  <div class="form-group" id="pesquisa2">
                    <div class="input-icon right" id="busca2">
                      <div class="col-md-12">
                        <input id="nome1" type="text" name="nome1" onkeypress="completar1();" placeholder="Nome do Convênio" class="form-control" /><br>
...
<script src="../../dist/js/funcs_conv_and_adm.js"></script>
