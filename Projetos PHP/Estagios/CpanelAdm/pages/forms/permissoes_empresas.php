...
<div class="content-wrapper">
    ...
    <div class="content">
      ...
      <!-- Small boxes (Stat box) -->
        ...
        $sql = mysql_query("SELECT * FROM usuarios_agencia WHERE tipo_usuario='empresa' AND status='Pendente'");
          ...
          echo'<br>
                <div class="box box-primary">
                  <div class="box-header">
                    <h3 class="box-title">Empresas Pendentes</h3>
                  </div>';
        ...
        mysql_select_db('estagios');
          ...
          if(isset($_POST['btn'])){
            ...
            echo '<script> window.location="permissoes_empresas.php" </script>';
          }
        ?>
