...
<head>
  ...
  <title>UFC - AgÃªncia de EstÃ¡gio</title>
...
<div class="content-wrapper">
    ...
    <div class="content">
      ...
      <!--PARTE DA PÃ�GINA QUE INSERE CURSO NOVO E SEU CENTRO-->
      <!-- SELECT2 EXAMPLE -->
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
            <form action="acao_inserir_curso.php" method="POST">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
      <!--PARTE USADA PARA ATUALIZAR QUALQUER CURSO QUE CONSTAR NA TABELA DE CURSOS, BASTA CONSULTAR E APRECERÃ� POR MEIO DE PESQUISA COM AUTOCOMPLETE-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
            <form action="page_atualizar_curso.php" method="POST">
              <div class="form-group">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
      <!--PARTE QUE IRÃ� EXCLUIR UM CURSO DE ACORDO COM A ESCOLHA-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
               <label>Escolha um curso para excluir</label>
                <form action="acao_deleta_curso.php" method="POST">
                <select class="form-control select2" name="CD_CURSO" style="width: 100%;">
                  <?php 
                    require('../../../conn.php');

                    $consulta = mysqli_query($conn,"SELECT * FROM cursos ORDER BY curso");
                    echo $result = mysqli_num_rows($consulta);
