...
<head>
  ...
  <script type="text/javascript">function direct90(){setTimeout("window.location='http://www.estagios.ufc.br/siges/public_html/CpanelAdm/pages/forms/cadastro_empresas_agentes.php',10");}</script>
...
function completar2() {
            ...
            $(document).ready(function(){
              $('#nome2').autocomplete(
              { 
                source: "search_consultar_empresa.php",
                minLength: 1,
                delay: 0
              });
      ...
      function consu1(){
      var mudar = document.getElementById("conempresa").style.display = 'none';  
      var mudar = document.getElementById("voltarbtn").style.display = 'none';  
            ...
            <section class="content">
             <div class="box box-primary collapsed-box">
                      <div class="box-header with-border">
                          <h3 class="box-title" id="nome_empresa">Consultar Empresa</h3>
                      ...
                      <div class="box-body">
                        <div class="form-group" id="btn" style="display: block;">
                              <form action="busca_tds_empresa_novo.php" method="POST">
                                <div class="form-group" id="pesquisa">
                                    <div class="input-icon right" id="busca">
                                        <div class="col-md-12">
                                           <input id="nome2" onkeypress="completar2()" onkeyup="consu1()" type="text" name="nome2" placeholder="Procurar Empresa" class="form-control" /><br>
                                       
                                          <div class="col-md-10"></div>
                                          <div class="col-md-2">
                                            <button type="submit" class="btn btn-block btn-primary" name="btnaempresacon" style="float: right; display:block;">Consultar</button>
                                          </div>
                                        </div>
                                      </div>
                                  </div>
              ...
              <!-- SELECT2 EXAMPLE -->
              <!--mostra apenas a consulta de uma empresa, sem a possibilidade de ocorrer uma alteração de dados nessa página-->
              <div class="box box-primary" id="conempresa" style="display:block;">
...
if(isset($_POST['btnaempresacon'])){

$valor = utf8_decode($_POST['nome2']);
...
if($resulatdo != 0){
  ...
  $CD_EMPRESA=$noticias->CD_EMPRESA;
  ...
  echo utf8_encode('<div class="row" >
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Nome da Empresa:</label>
                      <input type="text" name="nome_empresa" class="form-control" value="'.$noticias->nome.'">
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
                    <label>Endereco:</label>
                      <input type="text" name="endereco" class="form-control" value="'.$noticias->endereco.'">
                    <!-- /.input group -->
                  </div>
                  <div class="form-group">
                  ...
                  $consulta = mysql_query("SELECT * FROM tipo_empresa WHERE id_tipo_empresa LIKE '$noticias->CD_TIPO'");
                  $sql = mysql_fetch_array($consulta);
                  $nome = $sql['nome'];

                  echo utf8_encode('<option>'.$nome.'</option>');
                  ...
                  <div class="form-group">
                    <label>Email:</label>
                     <input type="text" name="email" class="form-control" value="'.$noticias->email.'">
                  </div>
                </div>
                <!-- /.col -->
                <div class="col-md-12">
                <div class="form-group">
                    <label>Representante Legal:</label>
                      <input type="text" name="representante" class="form-control" value="'.$noticias->representante.'">
                  </div>
                <div class="form-group">
                    <label>Cidade UF:</label>
                      <input type="text" name="uf" class="form-control" value="'.$noticias->cidade_uf.'">
                  </div>
                  <div class="form-group">
                    <label>CNPJ:</label>
                      <input type="text" name="cnpj" class="form-control" value="'.$noticias->cnpj.'">
                  </div>
                  <div class="form-group">
                    <label>CEP:</label>
                      <input type="text" name="cep" class="form-control" value="'.$noticias->cep.'">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="fone" class="form-control" value="'.$noticias->tel.'">
                    </div>
                    <!-- /.input group -->
                  </div>
                </div>
               ...
               <div class="col-md-12">
               <a href="cadastro_empresas_agentes.php"><button type="button" id="voltarbtn" style="display:block" class="btn btn-danger pull-right">Cancelar</button></a>
               </div>
              ');
...
if ($resulatdo == 0) {
     echo '<div class="note2 note-danger2"><h4 class="box-heading2"><Strong><font color="red">AVISO! </font></Strong></h4>
               ...
               <a href="cadastro_empresas_agentes.php"><button type="button" class="btn btn-danger pull-right">Cancelar</button></a>
               </div>';
  } 
