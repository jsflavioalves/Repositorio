...
<head>
  ...
  <script type="text/javascript">
    function Enviar(opc){
      if(opc == 1){
      document.form.action = "acao_consulta_customizada6.php";
      document.form.submit();
      }
      if(opc == 2){
      document.form.action = "acao_consulta_customizada_xls6.php";
      document.form.submit();
      }
    }
  </script>
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <center>
                  ...
                  <h3 class="box-title">CONSULTAS CUSTOMIZADAS (ATENDIMENTO):</h3>
                </center>
              </div>
              <!-- /.box-header -->
