            ...
            <section class="content">
              ...
              <div class="box box-primary">
                <div class="form-group">
                  ...
                  <div class="box-body">
                    <h3 class="box-title">Atualizar Matrícula</h3>
                  </div>
  <?php  
    $aluno = utf8_decode($_POST['aluno']);

    $busca_aluno = mysqli_query($conn,"SELECT * FROM alunos WHERE nome LIKE '$aluno' OR matricula LIKE '$aluno'");
    $array = mysqli_fetch_array($busca_aluno);
    $nome_aluno = utf8_encode($array['nome']);
    $matricula_antiga = $array['matricula'];

    echo '<form action="acao_atualizar_matricula.php" method="POST">
    <div id="dasinp2" style="display:block">
      <div class="col-md-6">
        <div class="form-group">
          <br>
          <label>Nome do Aluno:</label>
          <input type="text" id="nome_aluno" name="nome_aluno" placeholder="Nome do Aluno" value="'.$nome_aluno.'" class="form-control" disabled>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <br>
          <label>Matrícula Antiga:</label>
          <input type="text" id="matricula_antiga" name="matricula_antiga" value="'.$matricula_antiga.'" placeholder="Matrícula Antiga" class="form-control" disabled>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" id="nova_matricula" name="nova_matricula" placeholder="Nova Matrícula" class="form-control">
        </div>
      </div>
      <input type="hidden" name="nome_aluno" value="'.$nome_aluno.'">
      <input type="hidden" name="matricula_antiga" value="'.$matricula_antiga.'">
      <div class="col-md-12">
