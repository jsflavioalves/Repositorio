...
<head>
  ...
  <!-- FUNÃ‡Ã•ES JAVA SCRIPT -->
  <script>

   // FunÃ§Ãµes de autocomplete das inputs //
...
<!-- Onde encontramos o conteÃºdo da pÃ¡gina -->
  <div class="content-wrapper">
    ...
    <section class="content" id="cadastrar_aluno">
      ...
      <div class="row">
        <div class="col-md-12" style="display:block;">
          <section>
            <div class="col-xs-6">
                <!-- FormulÃ¡rio para Consultar Alunos -->
                <div class="box box-primary">
                  <div class="box-header with-border">
                      <h3 class="box-title" id="nome_empresa">Consultar Alunos</h3>
                  </div>
                  <div class="box-body">
                        ...
                        <form action="" method="POST" name="form" id="form" onSubmit="">
                          <div class="form-group" id="pesquisa">
                              <div class="input-icon right" id="busca">
                                <div class="col-md-12">
                                    <input id="aluno" onkeypress="completar_con_aluno()" type="text" name="aluno" placeholder="Nome/MatrÃ­cula do Aluno" class="form-control" /><br>
                                 
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                      <button type="submit" class="btn btn-block btn-success" name="btn_atualizar" onClick="Enviar(1);" style="float: left; display:block;">Trocar MatrÃ­cula</button>
                                    </div>
                                    <div class="col-md-4">
                                      <button type="submit" class="btn btn-block btn-primary" onClick="Enviar(2);" name="btnaluno" style="float: right; display:block;">Consultar</button>
                                    </div>
                                </div>
                              </div>
                          </div>
          ...
          <div class="col-xs-6">
                <!-- FormulÃ¡rio Para ExclusÃ£o de Alunos -->
                <div class="box box-primary collapsed-box">
                  <div class="box-header with-border">
                      <h3 class="box-title" id="nome_empresa">Excluir - Aluno</h3>
                  ...
                  <div class="box-body">
                    <div class="form-group" id="btn" style="display: block;">
                        <form action="acao_deleta_aluno.php" method="POST">
                          <div class="form-group" id="pesquisa">
                              <div class="input-icon right" id="busca">
                                <div class="col-md-12">
                                    <input id="aluno_del" onkeypress="completar_del_aluno()" type="text" name="aluno_del" placeholder="Nome do Aluno" class="form-control" required><br>
                                    <input id="mat_del" onkeypress="completar_del_aluno_mat()" type="text" name="mat_del" placeholder="Matricula do Aluno" class="form-control" required><br>
                                 
                                    <div class="col-md-8"></div>
                                    <div class="col-md-4">
                                      <button type="submit" class="btn btn-block btn-danger" name="btnalunodel" style="float: right; display:block;">Excluir</button>
                                    </div>
                                </div>
                              </div>
                          </div>
    ...
    <!-- FormulÃ¡rio para inserÃ§Ã£o de Alunos Internos  -->
    <div class="col-xs-12">
      <div class="col-xs-6">
        <form action="acao_inserir_aluno_interno.php" method="POST">
          <div class="box box-primary collapsed-box">
            ...
            <?php 
              require("../../../conn.php"); 
        //      mysqli_select_db('estagios');
              $sql4 = mysqli_query($conn,"SELECT * FROM cursos order by curso ASC");
            ...
            ?>  
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input name="matricula" class="form-control" type="text" placeholder="NÂº de Matricula" style="text-transform:uppercase" required>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input name="mae" class="form-control" type="text" placeholder="NOME DA MÃƒE" style="text-transform:uppercase" required>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input name="endereco" class="form-control" type="text" placeholder="ENDEREÃ‡O" style="text-transform:uppercase" required>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
      ...
      <div class="col-xs-6">
        ...
        <!-- FormulÃ¡rio Para inserÃ§Ã£o de Alunos Externos -->
        <form action="acao_inserir_aluno_externo.php" method="POST">
          <div class="box box-primary collapsed-box">
            <div class="box-header">
            ...
            ?>  
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input name="instituicao" class="form-control" type="text" placeholder="InstituiÃ§ao de Origem" style="text-transform:uppercase" required>
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input name="setor" class="form-control" type="text" placeholder="Setor/Unidade" style="text-transform:uppercase">
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
  ...
  <!-- BARRA DE CONFIGURAÃ‡ÃƒO DA PÃ�GINA -->
