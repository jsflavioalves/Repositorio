...
$sql = mysql_query("SELECT SUM(Replace(valor,'.','')) valor_total FROM termo_compromisso where dt_inicio like '%$valor%' and classificacao_termo like 'OBRIGATORIO' ");
...
elseif($vlr_t<10000){
  ...
  echo utf8_encode('<br><span class="info-box-number"><center><a onclick="siim_tceano()" id="nome_tceano">R$'); echo mask ($vlr_t,'#.###,00'); echo utf8_encode('</a></center></span>');
