...
if($resulatdo != 0){
  ...
  echo '<form action="acao_deleta_processo_convenio.php" method="POST">
  ...
  echo '      <br>
          ...
          echo '</table>
                <table class="table table-hover">
                  <tr>
                    <h4>N° do Processo a ser Excluido</h4>';?>
                    <select class="form-control select2" name="proc" style="width: 100%;" required>
                    <?php 
                      require('../../../conn.php');
...
<?php
      echo '    </tr>
                  ...
                  <div class="col-md-12">
                  <button type="submit" class="btn btn-primary pull-left" name="btna2">Continuar</button>
