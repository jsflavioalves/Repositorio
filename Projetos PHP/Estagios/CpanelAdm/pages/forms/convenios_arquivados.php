...
<head>
  ...
  <title>Agência de Estágio | Convênios Arquivados</title>
  ...
  <script src="../../dist/js/mascaras.js"></script>
    ...
    function divConv_arquivado() {
      var mudar = document.getElementById("tabela").style.display = 'none';
    }

    function completar_conv_arq() {
          
        
            $(document).ready(function(){
              $('#nome').autocomplete(
              { 
                source: "search_conv_arq.php",
                minLength: 1,
                delay: 0
              });
    ...
    function completar_del_conv_arq() {
          
        
            $(document).ready(function(){
              $('#nome1').autocomplete(
              { 
                source: "search_del_conv_arq.php",
                minLength: 1,
                delay: 0
              });
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">CONVÊNIOS ARQUIVADOS</h3>
              <div class="input-group input-group-sm" style="width: 150px; float:right;">
                <!-- FUNÇÃO (funcs_conv_arquivados_adm.js) E BUSCA (page_result_conv_arquivados.php) -->
                <input id="inputName1" onclick="divConv_arquivado();" onkeyup="buscarNoticias_Conv_arquivado(this.value)" type="text" placeholder="PROCURAR" class="form-control" />
                <div class="input-group-btn" id="conteudo_Conv_arquivado" onclick="divConv_arquivado();">
                  <button type="submit" class="btn btn-default"><i class="fa fa-search"></i></button>
                </div>
              </div><br>
            </div>
              <div id="resultado_Conv_arquivado"></div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding" id="tabela" style="display: block;" >
              <table class="table table-hover">
                ...
                <?php 
                  ...
                  $consulta = mysql_query("SELECT * FROM convenios_arquivados ORDER BY id_convenios_arquivados DESC");
                  ...
                  while($sql = mysql_fetch_array($consulta)){
                    ...
                    $status = $sql['status'];
                    $id_convenios_arquivados = $sql['id_convenios_arquivados'];

                    echo utf8_encode('
                        <form action="acao_mudar_tabela4.php" method="POST">
                          <tr>
                            ...
                            <td><label id="interessado">'.$interessado.'</label> <input type="hidden" value="'.$interessado.'" class="form-control" name="interessado" id="interessado"> </td>
                            ...
                            <td><label id="status">'.$status.'</label><input type="hidden" value="'.$status.'" class="form-control" name="status" id="status" onclick="editar();"></td>
                          </tr>');
                  } 
                ...
                <tr>
                  <td></td>
                  <form action="acao_inserir_conv_arquivados.php" method="POST">
                  ...
                  <td><input type="text" class="form-control" name="saida_procuradoria" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask></td>
                  ...
                  <td><input type="text" class="form-control" name="status" placeholder="Status"></td>
      ...
      <div class="row">
           ...
           <div class="box box-primary collapsed-box">
            ...
            <div class="box-body">
              <div class="form-group" id="btn3" style="display: block;">
                <form action="page_atualizar_conv_arquivados.php" method="POST">
                  <div class="form-group" id="pesquisa">
                    <div class="input-icon right" id="busca">
                      <div class="col-md-12">
                        <input id="nome" onkeypress="completar_conv_arq();" type="text" name="interessado" placeholder="Nome do Convênio" class="form-control" /><br>
                       
                        <div class="col-md-8"></div>
                        <div class="col-md-4">
                          <button type="submit" class="btn btn-block btn-primary" name="btna" style="float: right; display:block;">Atualizar</button>
                        </div>
                      </div>   
                    </div>
                ...
                <div id="conteudo" onclick="siim();" style="display:none"></div>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary collapsed-box">
            ...
            <div class="box-body">
              <div class="form-group" id="btn3" style="display: block;">
                <form action="acao_deleta_conv_arquivados.php" method="POST">
                  <div class="form-group" id="pesquisa">
                    <div class="input-icon right" id="busca">
                      <div class="col-md-12">
                        <input id="nome1" type="text" name="nome1" onkeypress="completar_del_conv_arq();" placeholder="Nome do Convênio" class="form-control" /><br>
                        <div class="col-md-8"></div>
                        <div class="col-md-4">
...
<script src="../../dist/js/funcs_conv_arquivados_adm.js"></script>
<!-- Page script -->
