...
<?php                                         $sqlsetor1 = mysqli_query($conn,"SELECT * FROM Setor ORDER BY nome_setor ");
                                               
                                                while ($noticiassetor1 = @mysqli_fetch_object($sqlsetor1)) {
...
<?php                                                 $sql5 = mysqli_query($conn,"SELECT * FROM agentes");
                                                    while($resultado5=mysqli_fetch_object($sql5)){
...
<?php                  
                                  echo'</select>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <div class="input-group"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                          <input type="text" id="inputName"  class="form-control" name="data_relatorio_1" id="data" size="50" maxlength="60" >
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <div class="input-group"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                          <input type="text" id="inputName"  class="form-control" name="data_relatorio_2" id="data" size="50" maxlength="60" >
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <div class="input-group"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                          <input type="text" id="inputName"  class="form-control" name="data_relatorio_3" id="data" size="50" maxlength="60" >
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <div class="input-group"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                          <input type="text" id="inputName"  class="form-control" name="data_relatorio_4" id="data" size="50" maxlength="60" >
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
