...
<section id="blog"> 
    <div class="container">
        ...
        <div class="col-sm-7">
            <div class="row">
                <div class="article">
                  <h2><span>Declaração</span> de equiparação de bolsas a estágio</h2>
                  <div class="clr"></div>
                  <p>A Agência de Estágios disponibiliza declaração contendo concessão de equiparação de atividades de extensão, monitoria e iniciação científica a estágio obrigatório. <strong>Assim, clique na opção desejada:</strong></p>
                   <a href="arquivos/Declaracao_ equiparacao_atividades_extensao.doc" target="_blank">Declaração de equiparação de bolsa a estágio</a>
                   <br> <br>
