...
<head> 
	...
	<title>Estágios UFC - Contato</title> 
    ...
    <div class="container">
      ...
      <div class="col-sm-6">
        ...
        <div class="article">
          ...
          <div class="clr"></div>
          <p> Para enviar vagas de estágio ou entrar em contato conosco. 
           Endereço: Avenida da Universidade, 2853 - Benfica - CEP 60020-181 - Fortaleza - CE
           Fone: (85) 3366 7413 (85) 3366 7413 Fax: (85) 3366 7881. Envie um email para gente, no caso de dúvidas e sugestões. <strong> E-mail: estagios@ufc.br </strong></p>
        </div>
        <div class="article">
          <div class="clr"></div>
          <div class="box box-primary">
        <div class="box-header with-border">
          <h4 class="box-title">ESCREVER E-MAIL</h4>
        </div>
        <!--PARTE QUE INSERE UM EMAIL NOVO-->
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <form action="enviar_email.php" method="POST">
                    ...
                    <ol>
                    <li>
                     <label for="name" style="color: #FF4500;">Nome (campo obrigatório)*</label>
                      <input type="text" class="form-control" name="nome" style="text-transform:uppercase" placeholder="NOME" required>
                    </li><br>
                    <li>
                    <label for="email" style="color: #FF4500;">Endereco de Email (campo obrigatório)*</label>
                      <input type="text" class="form-control" name="email" style="text-transform:uppercase" placeholder="EMAIL" required>
                    </li><br>
                    <li>
                     <label for="assunto" style="color: #FF4500;">Assunto (campo obrigatório)*</label>
                      <input type="text" class="form-control" name="assunto" style="text-transform:uppercase" placeholder="ASSUNTO" required>
                    </li><br>
                    <li>
                    <label for="message" style="color: #FF4500;">Sua Mensagem (campo obrigatório)*</label>
                      <textarea class="form-control" name="mensagem" style="text-transform:uppercase" rows="3" cols="50" required></textarea>
                    </li><br>
                    </ol>
                 
                  <div class="col-md-12"><br>
                    <button type="submit" class="btn btn-primary pull-right" name="btnemail">ENVIAR EMAIL</button>
                  </div>
                </form>
              </div>
            </div>
