...
<head> 
    ...
    <title>Estágios UFC - Legislação</title> 
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  ...
  <div class="col-sm-1"></div>
    ...
    <div class="row">
        <div class="article">
          <h4><span>Legislação</span> sobre Estágio</h4>
          <div class="clr"></div>
          <p>Seguimos os ditames da Lei federal N. 11.788, de 25 de setembro de 2008 e a Resolução No 32 de 30/10/2009 do CEPE/UFC.<strong>Tenha acesso pelos links a seguir:</strong></p>
           <a href="arquivos/Lei_11788_25_setembro_2008.pdf" target="_blank">Lei 11.788, de 25 de setembro de 2008</a>
           <br> <br>
           <a href="arquivos/UFC_Resolucao_32_CEPE_30.10.2009_Estagio.pdf" target="_blank">Resolução CEPE N. 32, de 30 de outubro de            2009</a>
           <br> <br>
           <a href="arquivos/Portaria 1 mes.pdf" target="_blank">Portaria nº 123, de 31 de agosto de 2018</a>
        </div>
      </div>
      </div>
