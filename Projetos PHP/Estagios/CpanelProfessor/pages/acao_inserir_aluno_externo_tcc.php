...
$uf=utf8_decode(strtoupper($_POST['uf']));
	...
	if($conta == 0){
		...
		$up = mysql_query("INSERT INTO alunos VALUES('','$nome', '$cpf','$rg','$matricula','$id_curso', '$curso','$instituicao','EXTERNO', '$mae', '$telefone', '$email' ,'$endereco', '$cidade','$uf')");
