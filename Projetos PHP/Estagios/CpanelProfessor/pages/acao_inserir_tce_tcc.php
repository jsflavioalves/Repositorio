...
$codigo_empresa=$_POST['concedente_n'];
...
$cd_cadastro=$_POST['cd_tcc'];


//Seleciona na taela 'empresas' todos os registros os quais seus nome são iguais ao valor do campo
$sql = mysql_query("SELECT * FROM empresas WHERE CD_EMPRESA LIKE '$codigo_empresa'");
...
$hr_fim_nn60=utf8_decode($_POST['hr_fim_n60']);
        ...
        // VERIFICA SE O TCC SELECIONADO EXISTI NO BANCO DE DADOS // 
