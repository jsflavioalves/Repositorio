...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <!--mostra as vagas de estágios de acordo com o grupo que o aluno irá escolher para visualizar-->
  <!--caso não esteja nenhuma vaga cadastrada no grupo que foi escolhido pelo o aluno para visualizar, mostrará uma informação em vermelho que o grupo não tem vagas de estágios cadastradas-->
...
<div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-8">
            ...
            <!-- /.box -->
            <!--codigo para verificar a tabela de vagas_estagios2-->
            <!--codigo tambem para mostrar quais as vagas que estao cadastradas em seu centro cadastrado junto com seu curso-->
            ...
            <?php
              require ('conn.php');
              mysql_select_db('estagios');
              if(isset($_POST['consvaga'])){

              // Recebe o valor enviado
              $valor = utf8_decode($_POST['CD_CENTRO']);

              $consulta = mysql_query("SELECT * FROM vagas_estagios WHERE CD_CENTRO LIKE '$valor'");
        ...
        echo'</div>';
                ...
                echo '<div class="alert alert-danger alert-dismissable"><strong>ATENÇÃO!</strong> NENHUMA VAGA DISPONÍVEL NESSE GRUPO!</div>';
              } 
            }
