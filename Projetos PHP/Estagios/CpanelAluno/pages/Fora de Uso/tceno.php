...
<head>
  ...
  <title>Agência de Estágios UFC | Termo de Compromisso Não Obrigatorio</title>
  ...
  <script type="text/javascript">function direct(){alert('SEU TERMO FOI ENVIADO COM SUCESSO PARA CONFIRMAÇÃO!'); setTimeout("window.location='tceno.php',100000"); }</script>
</head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Termo de Compromisso Não Obrigatório
      </h1>
    </section>
