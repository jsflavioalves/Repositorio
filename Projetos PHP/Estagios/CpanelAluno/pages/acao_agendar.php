...
$agendar = mysql_query("INSERT INTO agendamentos VALUES('', '$matricula_aluno', '$nome_aluno', '$telefone', '$email', '$escolha_dia/$escolha_mes/$escolha_ano', '$escolha_hora')");

$x = 1;
$atualizar = mysql_query("UPDATE vagas_agend SET qt_vagas=qt_vagas-'$x' WHERE mes='$escolha_mes' AND dia='$escolha_dia' AND hora='$escolha_hora'");
