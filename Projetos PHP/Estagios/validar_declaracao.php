	...
	<div class="container">
		<div class="text-center">
			<div class="col-sm-8 col-sm-offset-2">
				<h2 class="title-one">Validação de Declaração</h2>
				<p><P>PESQUISE O CÓDIGO DE VALIDAÇÃO DA SUA DECLARAÇÃO</P>.</p>
			</div>
		</div>
		<div class="about-us">
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="col-sm-6">
						<div class="panel panel-orange" style="width: 100%;">
						    <div class="panel-heading">Digite o Código de Validação</div>
						    <div class="panel-body pan">
						        <div class="form-body pal">
						            <div class="form-group" id="pesquisa">
						                <div class="input-icon right" id="busca2">
						                    <input id="inputName" style="text-transform: uppercase; color: #000000; width: 100%;height: 40px; border-radius: 10px;" onkeyup="buscarNoticias2(this.value)" type="text" placeholder="CÓDIGO DE VALIDAÇÃO" class="form-control" />
						                </div>
						                <div id="resultado2" onclick="consultaEmpresas();"></div>
						            </div>					        
						        </div>
						    </div>
						</div>
