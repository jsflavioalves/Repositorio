...
<section id="blog"> 
    <div class="container">
        ...
        <div class="col-sm-7">
            <div class="row">
                    <div class="article">
                      <h2><span>Relatorios</span> de Estagio</h2>
                      <div class="clr"></div>
                      <p>A Agência de Estágios disponibiliza modelo de relatórios de estágio. <strong>Assim, clique na opção desejada:</strong></p>
                       <a href="arquivos/Relatorio_de_ Atividades.doc" target="_blank"> Relatório de Atividades</a>
                       <br> <br>
                       <!--<a href="arquivos/UFC_Estagios_Rel_Atividades_Supervisor_Empresa.doc" target="_blank"> Relatório de Atividades - Supervisor</a>
                       <br> <br> -->
                    </div>
                    <div class="article">
