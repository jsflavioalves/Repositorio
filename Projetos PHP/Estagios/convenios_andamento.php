  ...
  <div class="container">
    <div class="text-center">
      <div class="col-sm-8 col-sm-offset-2">
        <h2 class="title-one">Convênios em Andamentos</h2>
        <p>Pesquise a empresa desejada. </p>
      </div>
    </div>
    <div class="about-us">
      <div class="row">
            ...
            <div class="box-body table-responsive no-padding" id="tabela" style="display: block;" >
              <table class="table table-hover" style="color:#000000">
                <tr>
                  ...
                  <th>Saida P/ PREX</th>
                  <th>Data assinatura/Convênio Ativo</th>
                  <th>Pendência</th>
                </tr>
                <?php 
...
<script src="funcs_conv_and_pagina.js"></script>
