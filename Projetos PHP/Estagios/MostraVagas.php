...
<head> 
	...
	<title>UFC - Vagas de Estágios</title> 
			...
			<div class="container"> 
				...
				<div class="collapse navbar-collapse"> 
					<ul class="nav navbar-nav navbar-right"> 
						...
						--><!--<li class="scroll"><a href="#" role="button" data-toggle="modal" data-target="#login-modal">login</a></li>
--> <!--
    	...
    	<div class="modal-dialog" >
			<div class="modal-content">
                ...
                <div id="div-forms">-->
                    ...
                    <!-- Begin # Login Form -->
                    <form id="login-form" method="POST" name="form1" action="login_vagas.php">
		                <div class="modal-body">
				    		...
				    		<input id="login_password" class="form-control" name="cpf" type="password" placeholder="CPF" onkeypress="mascara( this, mcpf );" maxlength="14"
				    		 required>
            ...
            while($resultado4=mysql_fetch_object($sql4)){echo utf8_encode('<option>'.$resultado4->curso.'</option>');}
                ...
                ?>  
                        ...
                        <!--    <select class="form-control" name="origem" style="width: 100%; margin-top: 10px;" required>
                            	<option value="" disabled="disabled" selected="selected">ORIGEM</option>
                             	<option value="INTERNO">INTERNO</option>
                             	<option value="EXTERNO">EXTERNO</option>
                            </select>
                            <input name="instituicao" class="form-control" type="text" placeholder="Instituição de Origem" style="text-transform:uppercase" required> -->
		    				...
		    				<select class="form-control" name="tipo_usuario" style="width: 100%; margin-top: 10px;" required>
                            ...
                            <input id="register_password" name="rg" class="form-control" type="text" onkeypress="mascara( this, mrg );" maxlength="12" placeholder="RG" style="text-transform:uppercase" required>
                            ...
                            <input id="register_username" name="email" class="form-control" type="text" placeholder="E-MAIL" style="text-transform:lowercase">
		...
		<div id="main-carousel" class="carousel slide" data-ride="carousel"> 
			...
			<!--<div class="carousel-inner">
				...
				<div class="item" style="background-image: url(images/slider/slide2.jpg)"> 
					...
					<br><br><br><br>
						<h2 class="heading animated bounceInDown">Termos de Convênio</h2>
			...
			<div class="item" style="background-image: url(images/slider/slide1.jpg)"> 
				<div class="carousel-caption"> 
					<div> 
					<br><br><br><br>
						<h2 class="heading animated bounceInRight">Termos de Compromisso de Estágio</h2> 
						...
						<div class="container">
							<div class="row text-center clearfix">
								<div class="col-sm-8 col-sm-offset-2">
									...
									<p class="blog-heading">Seguem aqui as ultimas ofertas de estágio para o seu grupo.</p>
								</div>
							</div> 
							<!-- <form action="vagas_pesquisar.php" method="POST">
                               <select class="form-control select2" name="id_grupovg" style="width: 100%;"> -->
                               <?php /*
                                   require ('conn.php');
                                   mysql_select_db('estagios');
                                   $consulta = mysql_query("SELECT * FROM grupo_vagas");
                                   echo $result = mysql_num_rows($consulta);

                                   while ($sql = mysql_fetch_array($consulta)) {
                                        $id_grupovg = $sql['id_grupovg'];
                          $descricao_grupo = $sql['descricao_grupo'];
                    
                          echo utf8_encode('<option value="'.$id_grupovg.'">'.$descricao_grupo.'</option>');
                            } */
                           ?>
                           <!--</select></br>
                              <button type="submit" name="vagasgrupo" class="btn btn-primary pull-right">Vagas</button>
                          </form> -->   
							<div class="row">
                                ...
                                if($permissao == "Pendente"){
                                    echo '<div class="alert alert-danger alert-dismissable"><strong>ATENÇÃO!</strong> VOCÊ AINDA NÃO FOI AUTORIZADO, FAVOR AGUARDAR AUTORIZAÇÃO!</div>';
                                } else if($permissao == "Autorizado"){

								$consultar=mysql_query("SELECT * FROM vagas_estagios WHERE id_grupo LIKE '$id_grupo' ORDER BY id_vagas_estagios");
								$result=mysql_num_rows($consultar);
