    ...
    <div class="container">
        ...
        <div class="col-sm-1"></div>
            <div class="col-sm-7">
                <div class="row">
                    <div class="article">
                      <h2><span>Aditivos</span> de Estágio</h2>
                      <div class="clr"></div>
                      <p>A Agência de Estágios disponibiliza modelos de aditivos de estágio. Onde poderam ser alteradas algumas cláusulas do contrato principal, como por exemplo a vigência e o valor da bolsa.<strong>Assim, clique na opção desejada:</strong></p>
                       <a href="arquivos/UFC_Estagios_Aditivo_Termo_Compromisso.doc" target="_blank"> Termo Aditivo ao Termo de Compromisso</a>
                       <br> 
                       <a href="arquivos/ADITIVO AO TERMO DE COMPROMISSO COLETIVO.doc" target="_blank">Aditivo de Termo de Compromisso Coletivo</a>
                       <br> 
