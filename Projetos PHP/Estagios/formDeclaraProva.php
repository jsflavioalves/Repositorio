...
<section id="blog"> 
    <div class="container">
        ...
        <div class="col-sm-7">
            <div class="row">
                <div class="article">
                  <h2><span>Declaração</span> para liberação nos dias de prova</h2>
                  <div class="clr"></div>
                  <p>A Agência de Estágios disponibiliza declaração contendo solicitação para liberação do estudante nos dias de avaliação. <strong>Assim, clique na opção desejada:</strong></p>
                   <a href="arquivos/Declaracao_Liberacao_dias_Prova.doc" target="_blank">Declaração</a>
                   <br> <br>
