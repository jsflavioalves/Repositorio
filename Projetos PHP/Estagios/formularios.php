...
<head> 
    ...
    <title>Estágios UFC - Formulários</title> 
    ...
    <div class="col-sm-1"></div>
      <div class="col-sm-6">
        <div class="row">
          ...
          <h4><span>Formulários</span> de Estágio</h4>
          <div class="clr"></div>
          <p>A Agência de Estágios atraves de sua assessoria jurídica preparou modelos prontos de documentos. Para uma maior operacionalização do trabalho e economia de tempo, disponibilizamos: termos de compromisso de estágio e de convênio predefinidos e cópia da apólice de seguro, forma de avaliação e relatório de estágios.<strong>Assim, clique na opção desejada:</strong></p>
           <a href="formTCs.php" target="_blank"> Quero emitir um termo de compromisso </a>
           <br> </br>
           <a href="formRenovar.php" target="_blank">Quero renovar/alterar/ meu estágio atual</a>
           <br> </br>
           <a href="formRelatorio.php" target="_blank"> Quero emitir uma recisão / relatório semestral</a>
           <br> </br>
           <a href="formConvenio.php" target="_blank"> Quero fazer um convênio para fins de estágio</a>
           <br> </br>
           <a href="formApolice.php" target="_blank"> Quero uma cópia da apólice de seguro de estágio obrigatório</a>
           <br> </br>
           <a href="formAvaliacao.php" target="_blank"> Quero saber como meu termo sera avaliado</a>
           <br> </br>
           <a href="formProrrogarObrig.php" target="_blank"> Quero prorrogar um estágio obrigatório</a>
           <br> </br>
           <a href="formDeclaraProva.php" target="_blank"> Quero emitir uma declaração para liberação nos dias de prova</a>
           <br> </br>
           <a href="formEquiparaBolsa.php" target="_blank"> Quero equiparar minhas atividades de extensão, de monitoria e de iniciação científica a estágio obrigatório</a>
