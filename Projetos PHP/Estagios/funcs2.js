...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('resultado2').innerHTML = 'Buscando Empresa ...';
	}
...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('conteudo2').innerHTML = 'Aguarde...';
	}
	...
	document.getElementById('conteudo2').innerHTML = resposta;
	}
}
req.send(null);
}