...
<head> 
   ...
   <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport"> 
    ...
    <title>Estágios UFC - Convênios</title> 
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
   ...
   <div class="col-sm-1"></div>
    ...
    <div class="row">
        ...
        <h4><span>Convênios</span> de Estágios</h4>
          <div class="clr"></div>
          <p>Lista de Empresas com Convênios de Estágios vigentes com a UFC. <strong>Para acessar a relação clique no link abaixo:</strong></p>
          <a href="http://www.estagios.ufc.br/siges/public_html/tds_convenio.php">Empresas com Convênios Vigentes</a>
          <p>Empresas com Convênios de Estágios com a UFC em andamento:</p>
          <a href="http://www.estagios.ufc.br/siges/public_html/convenios_andamento.php">Empresas com Convênios em Andamento</a>
